...
data AlbTargetGroupResource s = AlbTargetGroupResource'
    ...
    --
    , _healthCheck         :: TF.Attr s (AlbTargetGroupHealthCheckSetting s)
    ...
    -- ^ @slow_start@ - (Optional)
    --
    , _stickiness          :: TF.Attr s (AlbTargetGroupStickinessSetting s)
    -- ^ @stickiness@ - (Optional)
    --
    ...
    validator = TF.fieldsValidator (\AlbTargetGroupResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_namePrefix P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_healthCheck"
                  (_healthCheck
                      :: AlbTargetGroupResource s -> TF.Attr s (AlbTargetGroupHealthCheckSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_stickiness"
                  (_stickiness
                      :: AlbTargetGroupResource s -> TF.Attr s (AlbTargetGroupStickinessSetting s))
                  TF.validator
...
instance P.HasHealthCheck (AlbTargetGroupResource s) (TF.Attr s (AlbTargetGroupHealthCheckSetting s)) where
    healthCheck =
        P.lens (_healthCheck :: AlbTargetGroupResource s -> TF.Attr s (AlbTargetGroupHealthCheckSetting s))
...
instance P.HasStickiness (AlbTargetGroupResource s) (TF.Attr s (AlbTargetGroupStickinessSetting s)) where
    stickiness =
        P.lens (_stickiness :: AlbTargetGroupResource s -> TF.Attr s (AlbTargetGroupStickinessSetting s))
...
instance s ~ s' => P.HasComputedHealthCheck (TF.Ref s' (AlbTargetGroupResource s)) (TF.Attr s (AlbTargetGroupHealthCheckSetting s)) where
...
instance s ~ s' => P.HasComputedStickiness (TF.Ref s' (AlbTargetGroupResource s)) (TF.Attr s (AlbTargetGroupStickinessSetting s)) where
...
data AmiCopyResource s = AmiCopyResource'
    ...
    --
    , _ebsBlockDevice :: TF.Attr s [TF.Attr s (AmiCopyEbsBlockDeviceSetting s)]
    -- ^ @ebs_block_device@ - (Optional)
    --
    , _encrypted :: TF.Attr s P.Bool
    -- ^ @encrypted@ - (Optional, Forces New)
    --
    , _ephemeralBlockDevice :: TF.Attr s [TF.Attr s (AmiCopyEphemeralBlockDeviceSetting s)]
...
amiCopyResource
    :: TF.Attr s P.Text -- ^ @source_ami_id@ ('P._sourceAmiId', 'P.sourceAmiId')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @source_ami_region@ ('P._sourceAmiRegion', 'P.sourceAmiRegion')
...
instance P.HasEbsBlockDevice (AmiCopyResource s) (TF.Attr s [TF.Attr s (AmiCopyEbsBlockDeviceSetting s)]) where
    ebsBlockDevice =
        P.lens (_ebsBlockDevice :: AmiCopyResource s -> TF.Attr s [TF.Attr s (AmiCopyEbsBlockDeviceSetting s)])
...
instance P.HasEphemeralBlockDevice (AmiCopyResource s) (TF.Attr s [TF.Attr s (AmiCopyEphemeralBlockDeviceSetting s)]) where
    ephemeralBlockDevice =
        P.lens (_ephemeralBlockDevice :: AmiCopyResource s -> TF.Attr s [TF.Attr s (AmiCopyEphemeralBlockDeviceSetting s)])
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (AmiCopyResource s)) (TF.Attr s [TF.Attr s (AmiCopyEbsBlockDeviceSetting s)]) where
...
instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (AmiCopyResource s)) (TF.Attr s [TF.Attr s (AmiCopyEphemeralBlockDeviceSetting s)]) where
...
data AmiFromInstanceResource s = AmiFromInstanceResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _ebsBlockDevice :: TF.Attr s [TF.Attr s (AmiFromInstanceEbsBlockDeviceSetting s)]
    -- ^ @ebs_block_device@ - (Optional)
    --
    , _ephemeralBlockDevice :: TF.Attr s [TF.Attr s (AmiFromInstanceEphemeralBlockDeviceSetting s)]
    -- ^ @ephemeral_block_device@ - (Optional, Forces New)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Required, Forces New)
...
amiFromInstanceResource
    :: TF.Attr s P.Text -- ^ @source_instance_id@ ('P._sourceInstanceId', 'P.sourceInstanceId')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance P.HasEbsBlockDevice (AmiFromInstanceResource s) (TF.Attr s [TF.Attr s (AmiFromInstanceEbsBlockDeviceSetting s)]) where
    ebsBlockDevice =
        P.lens (_ebsBlockDevice :: AmiFromInstanceResource s -> TF.Attr s [TF.Attr s (AmiFromInstanceEbsBlockDeviceSetting s)])
               (\s a -> s { _ebsBlockDevice = a } :: AmiFromInstanceResource s)

instance P.HasEphemeralBlockDevice (AmiFromInstanceResource s) (TF.Attr s [TF.Attr s (AmiFromInstanceEphemeralBlockDeviceSetting s)]) where
    ephemeralBlockDevice =
        P.lens (_ephemeralBlockDevice :: AmiFromInstanceResource s -> TF.Attr s [TF.Attr s (AmiFromInstanceEphemeralBlockDeviceSetting s)])
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s [TF.Attr s (AmiFromInstanceEbsBlockDeviceSetting s)]) where
    computedEbsBlockDevice x = TF.compute (TF.refKey x) "ebs_block_device"

instance s ~ s' => P.HasComputedEnaSupport (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s P.Bool) where
    computedEnaSupport x = TF.compute (TF.refKey x) "ena_support"

instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s [TF.Attr s (AmiFromInstanceEphemeralBlockDeviceSetting s)]) where
    computedEphemeralBlockDevice x = TF.compute (TF.refKey x) "ephemeral_block_device"
...
data AmiResource s = AmiResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _ebsBlockDevice :: TF.Attr s [TF.Attr s (AmiEbsBlockDeviceSetting s)]
    -- ^ @ebs_block_device@ - (Optional)
    --
    , _enaSupport :: TF.Attr s P.Bool
    -- ^ @ena_support@ - (Optional, Forces New)
    --
    , _ephemeralBlockDevice :: TF.Attr s [TF.Attr s (AmiEphemeralBlockDeviceSetting s)]
    -- ^ @ephemeral_block_device@ - (Optional, Forces New)
    --
...
instance P.HasEbsBlockDevice (AmiResource s) (TF.Attr s [TF.Attr s (AmiEbsBlockDeviceSetting s)]) where
    ebsBlockDevice =
        P.lens (_ebsBlockDevice :: AmiResource s -> TF.Attr s [TF.Attr s (AmiEbsBlockDeviceSetting s)])
...
instance P.HasEphemeralBlockDevice (AmiResource s) (TF.Attr s [TF.Attr s (AmiEphemeralBlockDeviceSetting s)]) where
    ephemeralBlockDevice =
        P.lens (_ephemeralBlockDevice :: AmiResource s -> TF.Attr s [TF.Attr s (AmiEphemeralBlockDeviceSetting s)])
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (AmiResource s)) (TF.Attr s [TF.Attr s (AmiEbsBlockDeviceSetting s)]) where
    computedEbsBlockDevice x = TF.compute (TF.refKey x) "ebs_block_device"

instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (AmiResource s)) (TF.Attr s [TF.Attr s (AmiEphemeralBlockDeviceSetting s)]) where
    computedEphemeralBlockDevice x = TF.compute (TF.refKey x) "ephemeral_block_device"
...
instance s ~ s' => P.HasComputedThrottleSettings (TF.Ref s' (ApiGatewayAccountResource s)) (TF.Attr s (ApiGatewayAccountThrottleSettingsSetting s)) where
...
apiGatewayBasePathMappingResource
    :: TF.Attr s P.Text -- ^ @api_id@ ('P._apiId', 'P.apiId')
...
data ApiGatewayDocumentationPartResource s = ApiGatewayDocumentationPartResource'
    { _location   :: TF.Attr s (ApiGatewayDocumentationPartLocationSetting s)
...
apiGatewayDocumentationPartResource
    :: TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s (ApiGatewayDocumentationPartLocationSetting s) -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @properties@ ('P._properties', 'P.properties')
...
instance TF.IsValid (ApiGatewayDocumentationPartResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_location"
                  (_location
                      :: ApiGatewayDocumentationPartResource s -> TF.Attr s (ApiGatewayDocumentationPartLocationSetting s))
                  TF.validator

instance P.HasLocation (ApiGatewayDocumentationPartResource s) (TF.Attr s (ApiGatewayDocumentationPartLocationSetting s)) where
    location =
        P.lens (_location :: ApiGatewayDocumentationPartResource s -> TF.Attr s (ApiGatewayDocumentationPartLocationSetting s))
...
data ApiGatewayDomainNameResource s = ApiGatewayDomainNameResource'
    ...
    -- ^ @domain_name@ - (Required, Forces New)
    --
    , _endpointConfiguration :: TF.Attr s (ApiGatewayDomainNameEndpointConfigurationSetting s)
        ...
        , if (_regionalCertificateName P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_endpointConfiguration"
                  (_endpointConfiguration
                      :: ApiGatewayDomainNameResource s -> TF.Attr s (ApiGatewayDomainNameEndpointConfigurationSetting s))
                  TF.validator
...
instance P.HasEndpointConfiguration (ApiGatewayDomainNameResource s) (TF.Attr s (ApiGatewayDomainNameEndpointConfigurationSetting s)) where
    endpointConfiguration =
        P.lens (_endpointConfiguration :: ApiGatewayDomainNameResource s -> TF.Attr s (ApiGatewayDomainNameEndpointConfigurationSetting s))
...
instance s ~ s' => P.HasComputedEndpointConfiguration (TF.Ref s' (ApiGatewayDomainNameResource s)) (TF.Attr s (ApiGatewayDomainNameEndpointConfigurationSetting s)) where
...
apiGatewayGatewayResponseResource
    :: TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @response_type@ ('P._responseType', 'P.responseType')
...
apiGatewayIntegrationResource
    ...
    -> TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @http_method@ ('P._httpMethod', 'P.httpMethod')
...
apiGatewayIntegrationResponseResource
    :: TF.Attr s P.Text -- ^ @status_code@ ('P._statusCode', 'P.statusCode')
    -> TF.Attr s P.Text -- ^ @resource_id@ ('P._resourceId', 'P.resourceId')
    -> TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @http_method@ ('P._httpMethod', 'P.httpMethod')
...
apiGatewayMethodResource
    :: TF.Attr s P.Text -- ^ @authorization@ ('P._authorization', 'P.authorization')
    -> TF.Attr s P.Text -- ^ @resource_id@ ('P._resourceId', 'P.resourceId')
    -> TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @http_method@ ('P._httpMethod', 'P.httpMethod')
...
data ApiGatewayMethodSettingsResource s = ApiGatewayMethodSettingsResource'
    ...
    -- ^ @rest_api_id@ - (Required, Forces New)
    --
    , _settings   :: TF.Attr s (ApiGatewayMethodSettingsSettingsSetting s)
    -- ^ @settings@ - (Required)
    --
    , _stageName  :: TF.Attr s P.Text
    -- ^ @stage_name@ - (Required, Forces New)
...
apiGatewayMethodSettingsResource
    ...
    -> TF.Attr s (ApiGatewayMethodSettingsSettingsSetting s) -- ^ @settings@ ('P._settings', 'P.settings')
...
instance TF.IsValid (ApiGatewayMethodSettingsResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_settings"
                  (_settings
                      :: ApiGatewayMethodSettingsResource s -> TF.Attr s (ApiGatewayMethodSettingsSettingsSetting s))
                  TF.validator
...
instance P.HasSettings (ApiGatewayMethodSettingsResource s) (TF.Attr s (ApiGatewayMethodSettingsSettingsSetting s)) where
    settings =
        P.lens (_settings :: ApiGatewayMethodSettingsResource s -> TF.Attr s (ApiGatewayMethodSettingsSettingsSetting s))
...
apiGatewayModelResource
    :: TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @content_type@ ('P._contentType', 'P.contentType')
...
apiGatewayResourceResource
    :: TF.Attr s P.Text -- ^ @parent_id@ ('P._parentId', 'P.parentId')
    -> TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @path_part@ ('P._pathPart', 'P.pathPart')
...
data ApiGatewayRestApiResource s = ApiGatewayRestApiResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _endpointConfiguration :: TF.Attr s (ApiGatewayRestApiEndpointConfigurationSetting s)
    -- ^ @endpoint_configuration@ - (Optional)
    --
...
instance TF.IsValid (ApiGatewayRestApiResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_endpointConfiguration"
                  (_endpointConfiguration
                      :: ApiGatewayRestApiResource s -> TF.Attr s (ApiGatewayRestApiEndpointConfigurationSetting s))
                  TF.validator
...
instance P.HasEndpointConfiguration (ApiGatewayRestApiResource s) (TF.Attr s (ApiGatewayRestApiEndpointConfigurationSetting s)) where
    endpointConfiguration =
        P.lens (_endpointConfiguration :: ApiGatewayRestApiResource s -> TF.Attr s (ApiGatewayRestApiEndpointConfigurationSetting s))
...
instance s ~ s' => P.HasComputedEndpointConfiguration (TF.Ref s' (ApiGatewayRestApiResource s)) (TF.Attr s (ApiGatewayRestApiEndpointConfigurationSetting s)) where
    computedEndpointConfiguration x = TF.compute (TF.refKey x) "endpoint_configuration"
...
data ApiGatewayStageResource s = ApiGatewayStageResource'
    { _accessLogSettings :: TF.Attr s (ApiGatewayStageAccessLogSettingsSetting s)
...
apiGatewayStageResource
    :: TF.Attr s P.Text -- ^ @deployment_id@ ('P._deploymentId', 'P.deploymentId')
    -> TF.Attr s P.Text -- ^ @rest_api_id@ ('P._restApiId', 'P.restApiId')
    -> TF.Attr s P.Text -- ^ @stage_name@ ('P._stageName', 'P.stageName')
...
instance TF.IsValid (ApiGatewayStageResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_accessLogSettings"
                  (_accessLogSettings
                      :: ApiGatewayStageResource s -> TF.Attr s (ApiGatewayStageAccessLogSettingsSetting s))
                  TF.validator

instance P.HasAccessLogSettings (ApiGatewayStageResource s) (TF.Attr s (ApiGatewayStageAccessLogSettingsSetting s)) where
    accessLogSettings =
        P.lens (_accessLogSettings :: ApiGatewayStageResource s -> TF.Attr s (ApiGatewayStageAccessLogSettingsSetting s))
...
apiGatewayUsagePlanKeyResource
    ...
    -> TF.Attr s P.Text -- ^ @usage_plan_id@ ('P._usagePlanId', 'P.usagePlanId')
...
data ApiGatewayUsagePlanResource s = ApiGatewayUsagePlanResource'
    { _apiStages :: TF.Attr s [TF.Attr s (ApiGatewayUsagePlanApiStagesSetting s)]
    -- ^ @api_stages@ - (Optional)
    --
    , _description :: TF.Attr s P.Text
    -- ^ @description@ - (Optional)
    ...
    --
    , _quotaSettings :: TF.Attr s (ApiGatewayUsagePlanQuotaSettingsSetting s)
    -- ^ @quota_settings@ - (Optional)
    --
    , _throttleSettings :: TF.Attr s (ApiGatewayUsagePlanThrottleSettingsSetting s)
...
instance TF.IsValid (ApiGatewayUsagePlanResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_quotaSettings"
                  (_quotaSettings
                      :: ApiGatewayUsagePlanResource s -> TF.Attr s (ApiGatewayUsagePlanQuotaSettingsSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_throttleSettings"
                  (_throttleSettings
                      :: ApiGatewayUsagePlanResource s -> TF.Attr s (ApiGatewayUsagePlanThrottleSettingsSetting s))
                  TF.validator

instance P.HasApiStages (ApiGatewayUsagePlanResource s) (TF.Attr s [TF.Attr s (ApiGatewayUsagePlanApiStagesSetting s)]) where
    apiStages =
        P.lens (_apiStages :: ApiGatewayUsagePlanResource s -> TF.Attr s [TF.Attr s (ApiGatewayUsagePlanApiStagesSetting s)])
...
instance P.HasQuotaSettings (ApiGatewayUsagePlanResource s) (TF.Attr s (ApiGatewayUsagePlanQuotaSettingsSetting s)) where
    quotaSettings =
        P.lens (_quotaSettings :: ApiGatewayUsagePlanResource s -> TF.Attr s (ApiGatewayUsagePlanQuotaSettingsSetting s))
               (\s a -> s { _quotaSettings = a } :: ApiGatewayUsagePlanResource s)

instance P.HasThrottleSettings (ApiGatewayUsagePlanResource s) (TF.Attr s (ApiGatewayUsagePlanThrottleSettingsSetting s)) where
    throttleSettings =
        P.lens (_throttleSettings :: ApiGatewayUsagePlanResource s -> TF.Attr s (ApiGatewayUsagePlanThrottleSettingsSetting s))
...
apiGatewayVpcLinkResource
    :: TF.Attr s P.Text -- ^ @target_arns@ ('P._targetArns', 'P.targetArns')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
appCookieStickinessPolicyResource
    ...
    -> TF.Attr s P.Text -- ^ @cookie_name@ ('P._cookieName', 'P.cookieName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
data AppautoscalingPolicyResource s = AppautoscalingPolicyResource'
    ...
    --
    , _stepScalingPolicyConfiguration :: TF.Attr s [TF.Attr s (AppautoscalingPolicyStepScalingPolicyConfigurationSetting s)]
    -- ^ @step_scaling_policy_configuration@ - (Optional)
    --
    , _targetTrackingScalingPolicyConfiguration :: TF.Attr s (AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationSetting s)
...
appautoscalingPolicyResource
    :: TF.Attr s P.Text -- ^ @scalable_dimension@ ('P._scalableDimension', 'P.scalableDimension')
    -> TF.Attr s P.Text -- ^ @resource_id@ ('P._resourceId', 'P.resourceId')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @service_namespace@ ('P._serviceNamespace', 'P.serviceNamespace')
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_targetTrackingScalingPolicyConfiguration"
                  (_targetTrackingScalingPolicyConfiguration
                      :: AppautoscalingPolicyResource s -> TF.Attr s (AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationSetting s))
                  TF.validator
...
instance P.HasStepScalingPolicyConfiguration (AppautoscalingPolicyResource s) (TF.Attr s [TF.Attr s (AppautoscalingPolicyStepScalingPolicyConfigurationSetting s)]) where
    stepScalingPolicyConfiguration =
        P.lens (_stepScalingPolicyConfiguration :: AppautoscalingPolicyResource s -> TF.Attr s [TF.Attr s (AppautoscalingPolicyStepScalingPolicyConfigurationSetting s)])
               (\s a -> s { _stepScalingPolicyConfiguration = a } :: AppautoscalingPolicyResource s)

instance P.HasTargetTrackingScalingPolicyConfiguration (AppautoscalingPolicyResource s) (TF.Attr s (AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationSetting s)) where
    targetTrackingScalingPolicyConfiguration =
        P.lens (_targetTrackingScalingPolicyConfiguration :: AppautoscalingPolicyResource s -> TF.Attr s (AppautoscalingPolicyTargetTrackingScalingPolicyConfigurationSetting s))
...
data AppautoscalingScheduledActionResource s = AppautoscalingScheduledActionResource'
    ...
    --
    , _scalableTargetAction :: TF.Attr s (AppautoscalingScheduledActionScalableTargetActionSetting s)
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_scalableTargetAction"
                  (_scalableTargetAction
                      :: AppautoscalingScheduledActionResource s -> TF.Attr s (AppautoscalingScheduledActionScalableTargetActionSetting s))
                  TF.validator
...
instance P.HasScalableTargetAction (AppautoscalingScheduledActionResource s) (TF.Attr s (AppautoscalingScheduledActionScalableTargetActionSetting s)) where
    scalableTargetAction =
        P.lens (_scalableTargetAction :: AppautoscalingScheduledActionResource s -> TF.Attr s (AppautoscalingScheduledActionScalableTargetActionSetting s))
...
appautoscalingTargetResource
    :: TF.Attr s P.Int -- ^ @max_capacity@ ('P._maxCapacity', 'P.maxCapacity')
    -> TF.Attr s P.Int -- ^ @min_capacity@ ('P._minCapacity', 'P.minCapacity')
    -> TF.Attr s P.Text -- ^ @scalable_dimension@ ('P._scalableDimension', 'P.scalableDimension')
    -> TF.Attr s P.Text -- ^ @resource_id@ ('P._resourceId', 'P.resourceId')
    -> TF.Attr s P.Text -- ^ @service_namespace@ ('P._serviceNamespace', 'P.serviceNamespace')
...
data AppsyncDatasourceResource s = AppsyncDatasourceResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _dynamodbConfig :: TF.Attr s (AppsyncDatasourceDynamodbConfigSetting s)
    ...
    -- * 'elasticsearchConfig'
    -- * 'lambdaConfig'
    , _elasticsearchConfig :: TF.Attr s (AppsyncDatasourceElasticsearchConfigSetting s)
    ...
    -- * 'dynamodbConfig'
    -- * 'lambdaConfig'
    , _lambdaConfig :: TF.Attr s (AppsyncDatasourceLambdaConfigSetting s)
    ...
    validator = TF.fieldsValidator (\AppsyncDatasourceResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_lambdaConfig P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_dynamodbConfig"
                  (_dynamodbConfig
                      :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceDynamodbConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_elasticsearchConfig"
                  (_elasticsearchConfig
                      :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceElasticsearchConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_lambdaConfig"
                  (_lambdaConfig
                      :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceLambdaConfigSetting s))
                  TF.validator
...
instance P.HasDynamodbConfig (AppsyncDatasourceResource s) (TF.Attr s (AppsyncDatasourceDynamodbConfigSetting s)) where
    dynamodbConfig =
        P.lens (_dynamodbConfig :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceDynamodbConfigSetting s))
               (\s a -> s { _dynamodbConfig = a } :: AppsyncDatasourceResource s)

instance P.HasElasticsearchConfig (AppsyncDatasourceResource s) (TF.Attr s (AppsyncDatasourceElasticsearchConfigSetting s)) where
    elasticsearchConfig =
        P.lens (_elasticsearchConfig :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceElasticsearchConfigSetting s))
               (\s a -> s { _elasticsearchConfig = a } :: AppsyncDatasourceResource s)

instance P.HasLambdaConfig (AppsyncDatasourceResource s) (TF.Attr s (AppsyncDatasourceLambdaConfigSetting s)) where
    lambdaConfig =
        P.lens (_lambdaConfig :: AppsyncDatasourceResource s -> TF.Attr s (AppsyncDatasourceLambdaConfigSetting s))
...
data AppsyncGraphqlApiResource s = AppsyncGraphqlApiResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _userPoolConfig :: TF.Attr s (AppsyncGraphqlApiUserPoolConfigSetting s)
...
appsyncGraphqlApiResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @authentication_type@ ('P._authenticationType', 'P.authenticationType')
...
instance TF.IsValid (AppsyncGraphqlApiResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_userPoolConfig"
                  (_userPoolConfig
                      :: AppsyncGraphqlApiResource s -> TF.Attr s (AppsyncGraphqlApiUserPoolConfigSetting s))
                  TF.validator
...
instance P.HasUserPoolConfig (AppsyncGraphqlApiResource s) (TF.Attr s (AppsyncGraphqlApiUserPoolConfigSetting s)) where
    userPoolConfig =
        P.lens (_userPoolConfig :: AppsyncGraphqlApiResource s -> TF.Attr s (AppsyncGraphqlApiUserPoolConfigSetting s))
...
autoscalingAttachmentResource
    :: TF.Attr s P.Text -- ^ @autoscaling_group_name@ ('P._autoscalingGroupName', 'P.autoscalingGroupName')
...
data AutoscalingGroupResource s = AutoscalingGroupResource'
    ...
    --
    , _initialLifecycleHook :: TF.Attr s [TF.Attr s (AutoscalingGroupInitialLifecycleHookSetting s)]
    ...
    --
    -- * 'launchTemplate'
    , _launchTemplate :: TF.Attr s (AutoscalingGroupLaunchTemplateSetting s)
    ...
    --
    , _tag :: TF.Attr s [TF.Attr s (AutoscalingGroupTagSetting s)]
    -- ^ @tag@ - (Optional)
    --
    -- Conflicts with:
    --
...
autoscalingGroupResource
    :: TF.Attr s P.Int -- ^ @max_size@ ('P._maxSize', 'P.maxSize')
    -> TF.Attr s P.Int -- ^ @min_size@ ('P._minSize', 'P.minSize')
    ...
    validator = TF.fieldsValidator (\AutoscalingGroupResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_tags P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_launchTemplate"
                  (_launchTemplate
                      :: AutoscalingGroupResource s -> TF.Attr s (AutoscalingGroupLaunchTemplateSetting s))
                  TF.validator
...
instance P.HasInitialLifecycleHook (AutoscalingGroupResource s) (TF.Attr s [TF.Attr s (AutoscalingGroupInitialLifecycleHookSetting s)]) where
    initialLifecycleHook =
        P.lens (_initialLifecycleHook :: AutoscalingGroupResource s -> TF.Attr s [TF.Attr s (AutoscalingGroupInitialLifecycleHookSetting s)])
...
instance P.HasLaunchTemplate (AutoscalingGroupResource s) (TF.Attr s (AutoscalingGroupLaunchTemplateSetting s)) where
    launchTemplate =
        P.lens (_launchTemplate :: AutoscalingGroupResource s -> TF.Attr s (AutoscalingGroupLaunchTemplateSetting s))
...
instance P.HasTag (AutoscalingGroupResource s) (TF.Attr s [TF.Attr s (AutoscalingGroupTagSetting s)]) where
    tag =
        P.lens (_tag :: AutoscalingGroupResource s -> TF.Attr s [TF.Attr s (AutoscalingGroupTagSetting s)])
...
autoscalingLifecycleHookResource
    :: TF.Attr s P.Text -- ^ @autoscaling_group_name@ ('P._autoscalingGroupName', 'P.autoscalingGroupName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @lifecycle_transition@ ('P._lifecycleTransition', 'P.lifecycleTransition')
...
autoscalingNotificationResource
    ...
    -> TF.Attr s [TF.Attr s P.Text] -- ^ @group_names@ ('P._groupNames', 'P.groupNames')
    -> TF.Attr s [TF.Attr s P.Text] -- ^ @notifications@ ('P._notifications', 'P.notifications')
...
data AutoscalingPolicyResource s = AutoscalingPolicyResource'
    ...
    --
    -- * 'stepAdjustment'
    , _stepAdjustment :: TF.Attr s [TF.Attr s (AutoscalingPolicyStepAdjustmentSetting s)]
    -- ^ @step_adjustment@ - (Optional)
    --
    -- Conflicts with:
    --
    -- * 'scalingAdjustment'
    , _targetTrackingConfiguration :: TF.Attr s (AutoscalingPolicyTargetTrackingConfigurationSetting s)
        ...
        , if (_stepAdjustment P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_targetTrackingConfiguration"
                  (_targetTrackingConfiguration
                      :: AutoscalingPolicyResource s -> TF.Attr s (AutoscalingPolicyTargetTrackingConfigurationSetting s))
                  TF.validator
...
instance P.HasStepAdjustment (AutoscalingPolicyResource s) (TF.Attr s [TF.Attr s (AutoscalingPolicyStepAdjustmentSetting s)]) where
    stepAdjustment =
        P.lens (_stepAdjustment :: AutoscalingPolicyResource s -> TF.Attr s [TF.Attr s (AutoscalingPolicyStepAdjustmentSetting s)])
               (\s a -> s { _stepAdjustment = a } :: AutoscalingPolicyResource s)

instance P.HasTargetTrackingConfiguration (AutoscalingPolicyResource s) (TF.Attr s (AutoscalingPolicyTargetTrackingConfigurationSetting s)) where
    targetTrackingConfiguration =
        P.lens (_targetTrackingConfiguration :: AutoscalingPolicyResource s -> TF.Attr s (AutoscalingPolicyTargetTrackingConfigurationSetting s))
...
autoscalingScheduleResource
    :: TF.Attr s P.Text -- ^ @autoscaling_group_name@ ('P._autoscalingGroupName', 'P.autoscalingGroupName')
    -> TF.Attr s P.Text -- ^ @scheduled_action_name@ ('P._scheduledActionName', 'P.scheduledActionName')
...
data BatchComputeEnvironmentResource s = BatchComputeEnvironmentResource'
    ...
    --
    , _computeResources :: TF.Attr s (BatchComputeEnvironmentComputeResourcesSetting s)
...
instance TF.IsValid (BatchComputeEnvironmentResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_computeResources"
                  (_computeResources
                      :: BatchComputeEnvironmentResource s -> TF.Attr s (BatchComputeEnvironmentComputeResourcesSetting s))
                  TF.validator
...
instance P.HasComputeResources (BatchComputeEnvironmentResource s) (TF.Attr s (BatchComputeEnvironmentComputeResourcesSetting s)) where
    computeResources =
        P.lens (_computeResources :: BatchComputeEnvironmentResource s -> TF.Attr s (BatchComputeEnvironmentComputeResourcesSetting s))
...
data BatchJobDefinitionResource s = BatchJobDefinitionResource'
    ...
    --
    , _retryStrategy :: TF.Attr s (BatchJobDefinitionRetryStrategySetting s)
    -- ^ @retry_strategy@ - (Optional, Forces New)
    --
    , _timeout :: TF.Attr s (BatchJobDefinitionTimeoutSetting s)
...
instance TF.IsValid (BatchJobDefinitionResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_retryStrategy"
                  (_retryStrategy
                      :: BatchJobDefinitionResource s -> TF.Attr s (BatchJobDefinitionRetryStrategySetting s))
                  TF.validator
           P.<> TF.settingsValidator "_timeout"
                  (_timeout
                      :: BatchJobDefinitionResource s -> TF.Attr s (BatchJobDefinitionTimeoutSetting s))
                  TF.validator
...
instance P.HasRetryStrategy (BatchJobDefinitionResource s) (TF.Attr s (BatchJobDefinitionRetryStrategySetting s)) where
    retryStrategy =
        P.lens (_retryStrategy :: BatchJobDefinitionResource s -> TF.Attr s (BatchJobDefinitionRetryStrategySetting s))
               (\s a -> s { _retryStrategy = a } :: BatchJobDefinitionResource s)

instance P.HasTimeout (BatchJobDefinitionResource s) (TF.Attr s (BatchJobDefinitionTimeoutSetting s)) where
    timeout =
        P.lens (_timeout :: BatchJobDefinitionResource s -> TF.Attr s (BatchJobDefinitionTimeoutSetting s))
...
batchJobQueueResource
    :: TF.Attr s [TF.Attr s P.Text] -- ^ @compute_environments@ ('P._computeEnvironments', 'P.computeEnvironments')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Int -- ^ @priority@ ('P._priority', 'P.priority')
    -> TF.Attr s P.Text -- ^ @state@ ('P._state', 'P.state')
...
data BudgetsBudgetResource s = BudgetsBudgetResource'
    ...
    --
    , _costTypes       :: TF.Attr s (BudgetsBudgetCostTypesSetting s)
    -- ^ @cost_types@ - (Optional)
    --
...
budgetsBudgetResource
    :: TF.Attr s P.Text -- ^ @limit_amount@ ('P._limitAmount', 'P.limitAmount')
    -> TF.Attr s P.Text -- ^ @time_period_start@ ('P._timePeriodStart', 'P.timePeriodStart')
    -> TF.Attr s P.Text -- ^ @budget_type@ ('P._budgetType', 'P.budgetType')
    -> TF.Attr s P.Text -- ^ @limit_unit@ ('P._limitUnit', 'P.limitUnit')
    -> TF.Attr s P.Text -- ^ @time_unit@ ('P._timeUnit', 'P.timeUnit')
    ...
    validator = TF.fieldsValidator (\BudgetsBudgetResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_namePrefix P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_costTypes"
                  (_costTypes
                      :: BudgetsBudgetResource s -> TF.Attr s (BudgetsBudgetCostTypesSetting s))
                  TF.validator
...
instance P.HasCostTypes (BudgetsBudgetResource s) (TF.Attr s (BudgetsBudgetCostTypesSetting s)) where
    costTypes =
        P.lens (_costTypes :: BudgetsBudgetResource s -> TF.Attr s (BudgetsBudgetCostTypesSetting s))
...
instance s ~ s' => P.HasComputedCostTypes (TF.Ref s' (BudgetsBudgetResource s)) (TF.Attr s (BudgetsBudgetCostTypesSetting s)) where
...
data CloudfrontDistributionResource s = CloudfrontDistributionResource'
    ...
    -- ^ @comment@ - (Optional)
    --
    , _customErrorResponse :: TF.Attr s [TF.Attr s (CloudfrontDistributionCustomErrorResponseSetting s)]
    -- ^ @custom_error_response@ - (Optional)
    --
    , _defaultCacheBehavior :: TF.Attr s (CloudfrontDistributionDefaultCacheBehaviorSetting s)
    ...
    --
    , _loggingConfig :: TF.Attr s (CloudfrontDistributionLoggingConfigSetting s)
    -- ^ @logging_config@ - (Optional)
    --
    , _orderedCacheBehavior :: TF.Attr s [TF.Attr s (CloudfrontDistributionOrderedCacheBehaviorSetting s)]
    -- ^ @ordered_cache_behavior@ - (Optional)
    --
    , _origin :: TF.Attr s [TF.Attr s (CloudfrontDistributionOriginSetting s)]
    -- ^ @origin@ - (Required)
    --
    , _priceClass :: TF.Attr s P.Text
    -- ^ @price_class@ - (Optional)
    --
    , _restrictions :: TF.Attr s (CloudfrontDistributionRestrictionsSetting s)
    ...
    -- ^ @tags@ - (Optional)
    --
    , _viewerCertificate :: TF.Attr s (CloudfrontDistributionViewerCertificateSetting s)
...
cloudfrontDistributionResource
    :: TF.Attr s (CloudfrontDistributionDefaultCacheBehaviorSetting s) -- ^ @default_cache_behavior@ ('P._defaultCacheBehavior', 'P.defaultCacheBehavior')
    -> TF.Attr s (CloudfrontDistributionViewerCertificateSetting s) -- ^ @viewer_certificate@ ('P._viewerCertificate', 'P.viewerCertificate')
    -> TF.Attr s P.Bool -- ^ @enabled@ ('P._enabled', 'P.enabled')
    -> TF.Attr s [TF.Attr s (CloudfrontDistributionOriginSetting s)] -- ^ @origin@ ('P._origin', 'P.origin')
    -> TF.Attr s (CloudfrontDistributionRestrictionsSetting s) -- ^ @restrictions@ ('P._restrictions', 'P.restrictions')
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_defaultCacheBehavior"
                  (_defaultCacheBehavior
                      :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionDefaultCacheBehaviorSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_loggingConfig"
                  (_loggingConfig
                      :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionLoggingConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_restrictions"
                  (_restrictions
                      :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionRestrictionsSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_viewerCertificate"
                  (_viewerCertificate
                      :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionViewerCertificateSetting s))
                  TF.validator
...
instance P.HasCustomErrorResponse (CloudfrontDistributionResource s) (TF.Attr s [TF.Attr s (CloudfrontDistributionCustomErrorResponseSetting s)]) where
    customErrorResponse =
        P.lens (_customErrorResponse :: CloudfrontDistributionResource s -> TF.Attr s [TF.Attr s (CloudfrontDistributionCustomErrorResponseSetting s)])
               (\s a -> s { _customErrorResponse = a } :: CloudfrontDistributionResource s)

instance P.HasDefaultCacheBehavior (CloudfrontDistributionResource s) (TF.Attr s (CloudfrontDistributionDefaultCacheBehaviorSetting s)) where
    defaultCacheBehavior =
        P.lens (_defaultCacheBehavior :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionDefaultCacheBehaviorSetting s))
...
instance P.HasLoggingConfig (CloudfrontDistributionResource s) (TF.Attr s (CloudfrontDistributionLoggingConfigSetting s)) where
    loggingConfig =
        P.lens (_loggingConfig :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionLoggingConfigSetting s))
               (\s a -> s { _loggingConfig = a } :: CloudfrontDistributionResource s)

instance P.HasOrderedCacheBehavior (CloudfrontDistributionResource s) (TF.Attr s [TF.Attr s (CloudfrontDistributionOrderedCacheBehaviorSetting s)]) where
    orderedCacheBehavior =
        P.lens (_orderedCacheBehavior :: CloudfrontDistributionResource s -> TF.Attr s [TF.Attr s (CloudfrontDistributionOrderedCacheBehaviorSetting s)])
               (\s a -> s { _orderedCacheBehavior = a } :: CloudfrontDistributionResource s)

instance P.HasOrigin (CloudfrontDistributionResource s) (TF.Attr s [TF.Attr s (CloudfrontDistributionOriginSetting s)]) where
    origin =
        P.lens (_origin :: CloudfrontDistributionResource s -> TF.Attr s [TF.Attr s (CloudfrontDistributionOriginSetting s)])
...
instance P.HasRestrictions (CloudfrontDistributionResource s) (TF.Attr s (CloudfrontDistributionRestrictionsSetting s)) where
    restrictions =
        P.lens (_restrictions :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionRestrictionsSetting s))
...
instance P.HasViewerCertificate (CloudfrontDistributionResource s) (TF.Attr s (CloudfrontDistributionViewerCertificateSetting s)) where
    viewerCertificate =
        P.lens (_viewerCertificate :: CloudfrontDistributionResource s -> TF.Attr s (CloudfrontDistributionViewerCertificateSetting s))
...
data CloudtrailResource s = CloudtrailResource'
    ...
    --
    , _eventSelector :: TF.Attr s [TF.Attr s (CloudtrailEventSelectorSetting s)]
...
instance P.HasEventSelector (CloudtrailResource s) (TF.Attr s [TF.Attr s (CloudtrailEventSelectorSetting s)]) where
    eventSelector =
        P.lens (_eventSelector :: CloudtrailResource s -> TF.Attr s [TF.Attr s (CloudtrailEventSelectorSetting s)])
...
cloudwatchDashboardResource
    :: TF.Attr s P.Text -- ^ @dashboard_body@ ('P._dashboardBody', 'P.dashboardBody')
    -> TF.Attr s P.Text -- ^ @dashboard_name@ ('P._dashboardName', 'P.dashboardName')
...
cloudwatchEventPermissionResource
    :: TF.Attr s P.Text -- ^ @statement_id@ ('P._statementId', 'P.statementId')
...
data CloudwatchEventTargetResource s = CloudwatchEventTargetResource'
    ...
    -- ^ @arn@ - (Required)
    --
    , _batchTarget :: TF.Attr s (CloudwatchEventTargetBatchTargetSetting s)
    -- ^ @batch_target@ - (Optional)
    --
    , _ecsTarget :: TF.Attr s (CloudwatchEventTargetEcsTargetSetting s)
    -- ^ @ecs_target@ - (Optional)
    --
    ...
    --
    -- * 'input'
    , _inputTransformer :: TF.Attr s (CloudwatchEventTargetInputTransformerSetting s)
    -- ^ @input_transformer@ - (Optional)
    --
    , _kinesisTarget :: TF.Attr s (CloudwatchEventTargetKinesisTargetSetting s)
    ...
    --
    , _runCommandTargets :: TF.Attr s [TF.Attr s (CloudwatchEventTargetRunCommandTargetsSetting s)]
    -- ^ @run_command_targets@ - (Optional)
    --
    , _sqsTarget :: TF.Attr s (CloudwatchEventTargetSqsTargetSetting s)
    -- ^ @sqs_target@ - (Optional)
    --
    , _targetId :: TF.Attr s P.Text
    ...
    validator = TF.fieldsValidator (\CloudwatchEventTargetResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_inputPath P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_batchTarget"
                  (_batchTarget
                      :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetBatchTargetSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_ecsTarget"
                  (_ecsTarget
                      :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetEcsTargetSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_inputTransformer"
                  (_inputTransformer
                      :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetInputTransformerSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_kinesisTarget"
                  (_kinesisTarget
                      :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetKinesisTargetSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_sqsTarget"
                  (_sqsTarget
                      :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetSqsTargetSetting s))
                  TF.validator
...
instance P.HasBatchTarget (CloudwatchEventTargetResource s) (TF.Attr s (CloudwatchEventTargetBatchTargetSetting s)) where
    batchTarget =
        P.lens (_batchTarget :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetBatchTargetSetting s))
               (\s a -> s { _batchTarget = a } :: CloudwatchEventTargetResource s)

instance P.HasEcsTarget (CloudwatchEventTargetResource s) (TF.Attr s (CloudwatchEventTargetEcsTargetSetting s)) where
    ecsTarget =
        P.lens (_ecsTarget :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetEcsTargetSetting s))
...
instance P.HasInputTransformer (CloudwatchEventTargetResource s) (TF.Attr s (CloudwatchEventTargetInputTransformerSetting s)) where
    inputTransformer =
        P.lens (_inputTransformer :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetInputTransformerSetting s))
               (\s a -> s { _inputTransformer = a } :: CloudwatchEventTargetResource s)

instance P.HasKinesisTarget (CloudwatchEventTargetResource s) (TF.Attr s (CloudwatchEventTargetKinesisTargetSetting s)) where
    kinesisTarget =
        P.lens (_kinesisTarget :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetKinesisTargetSetting s))
...
instance P.HasRunCommandTargets (CloudwatchEventTargetResource s) (TF.Attr s [TF.Attr s (CloudwatchEventTargetRunCommandTargetsSetting s)]) where
    runCommandTargets =
        P.lens (_runCommandTargets :: CloudwatchEventTargetResource s -> TF.Attr s [TF.Attr s (CloudwatchEventTargetRunCommandTargetsSetting s)])
               (\s a -> s { _runCommandTargets = a } :: CloudwatchEventTargetResource s)

instance P.HasSqsTarget (CloudwatchEventTargetResource s) (TF.Attr s (CloudwatchEventTargetSqsTargetSetting s)) where
    sqsTarget =
        P.lens (_sqsTarget :: CloudwatchEventTargetResource s -> TF.Attr s (CloudwatchEventTargetSqsTargetSetting s))
...
cloudwatchLogDestinationPolicyResource
    ...
    -> TF.Attr s P.Text -- ^ @access_policy@ ('P._accessPolicy', 'P.accessPolicy')
...
data CloudwatchLogMetricFilterResource s = CloudwatchLogMetricFilterResource'
    ...
    --
    , _metricTransformation :: TF.Attr s (CloudwatchLogMetricFilterMetricTransformationSetting s)
...
cloudwatchLogMetricFilterResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @pattern@ ('P._pattern'', 'P.pattern'')
    -> TF.Attr s (CloudwatchLogMetricFilterMetricTransformationSetting s) -- ^ @metric_transformation@ ('P._metricTransformation', 'P.metricTransformation')
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_metricTransformation"
                  (_metricTransformation
                      :: CloudwatchLogMetricFilterResource s -> TF.Attr s (CloudwatchLogMetricFilterMetricTransformationSetting s))
                  TF.validator
...
instance P.HasMetricTransformation (CloudwatchLogMetricFilterResource s) (TF.Attr s (CloudwatchLogMetricFilterMetricTransformationSetting s)) where
    metricTransformation =
        P.lens (_metricTransformation :: CloudwatchLogMetricFilterResource s -> TF.Attr s (CloudwatchLogMetricFilterMetricTransformationSetting s))
...
cloudwatchLogResourcePolicyResource
    :: TF.Attr s P.Text -- ^ @policy_document@ ('P._policyDocument', 'P.policyDocument')
...
cloudwatchLogSubscriptionFilterResource
    :: TF.Attr s P.Text -- ^ @destination_arn@ ('P._destinationArn', 'P.destinationArn')
    -> TF.Attr s P.Text -- ^ @log_group_name@ ('P._logGroupName', 'P.logGroupName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @filter_pattern@ ('P._filterPattern', 'P.filterPattern')
...
cloudwatchMetricAlarmResource
    :: TF.Attr s P.Text -- ^ @alarm_name@ ('P._alarmName', 'P.alarmName')
    -> TF.Attr s P.Text -- ^ @metric_name@ ('P._metricName', 'P.metricName')
    -> TF.Attr s P.Text -- ^ @namespace@ ('P._namespace', 'P.namespace')
    -> TF.Attr s P.Text -- ^ @comparison_operator@ ('P._comparisonOperator', 'P.comparisonOperator')
    -> TF.Attr s P.Int -- ^ @period@ ('P._period', 'P.period')
    -> TF.Attr s P.Int -- ^ @evaluation_periods@ ('P._evaluationPeriods', 'P.evaluationPeriods')
...
codebuildProjectResource
    :: TF.Attr s (CodebuildProjectArtifactsSetting s) -- ^ @artifacts@ ('P._artifacts', 'P.artifacts')
    -> TF.Attr s (CodebuildProjectEnvironmentSetting s) -- ^ @environment@ ('P._environment', 'P.environment')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @service_role@ ('P._serviceRole', 'P.serviceRole')
    -> TF.Attr s (CodebuildProjectSourceSetting s) -- ^ @source@ ('P._source', 'P.source')
...
instance TF.IsValid (CodebuildProjectResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_artifacts"
                  (_artifacts
                      :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectArtifactsSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_cache"
                  (_cache
                      :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectCacheSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_environment"
                  (_environment
                      :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectEnvironmentSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_source"
                  (_source
                      :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectSourceSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_vpcConfig"
                  (_vpcConfig
                      :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectVpcConfigSetting s))
                  TF.validator

instance P.HasArtifacts (CodebuildProjectResource s) (TF.Attr s (CodebuildProjectArtifactsSetting s)) where
    artifacts =
        P.lens (_artifacts :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectArtifactsSetting s))
...
instance P.HasCache (CodebuildProjectResource s) (TF.Attr s (CodebuildProjectCacheSetting s)) where
    cache =
        P.lens (_cache :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectCacheSetting s))
...
instance P.HasEnvironment (CodebuildProjectResource s) (TF.Attr s (CodebuildProjectEnvironmentSetting s)) where
    environment =
        P.lens (_environment :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectEnvironmentSetting s))
...
instance P.HasSource (CodebuildProjectResource s) (TF.Attr s (CodebuildProjectSourceSetting s)) where
    source =
        P.lens (_source :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectSourceSetting s))
...
instance P.HasVpcConfig (CodebuildProjectResource s) (TF.Attr s (CodebuildProjectVpcConfigSetting s)) where
    vpcConfig =
        P.lens (_vpcConfig :: CodebuildProjectResource s -> TF.Attr s (CodebuildProjectVpcConfigSetting s))
...
data CodecommitTriggerResource s = CodecommitTriggerResource'
    ...
    -- ^ @repository_name@ - (Required, Forces New)
    --
    , _trigger :: TF.Attr s [TF.Attr s (CodecommitTriggerTriggerSetting s)]
...
codecommitTriggerResource
    :: TF.Attr s P.Text -- ^ @repository_name@ ('P._repositoryName', 'P.repositoryName')
    -> TF.Attr s [TF.Attr s (CodecommitTriggerTriggerSetting s)] -- ^ @trigger@ ('P._trigger', 'P.trigger')
...
instance P.HasTrigger (CodecommitTriggerResource s) (TF.Attr s [TF.Attr s (CodecommitTriggerTriggerSetting s)]) where
    trigger =
        P.lens (_trigger :: CodecommitTriggerResource s -> TF.Attr s [TF.Attr s (CodecommitTriggerTriggerSetting s)])
...
data CodedeployDeploymentConfigResource s = CodedeployDeploymentConfigResource'
    ...
    --
    , _minimumHealthyHosts :: TF.Attr s (CodedeployDeploymentConfigMinimumHealthyHostsSetting s)
...
codedeployDeploymentConfigResource
    :: TF.Attr s (CodedeployDeploymentConfigMinimumHealthyHostsSetting s) -- ^ @minimum_healthy_hosts@ ('P._minimumHealthyHosts', 'P.minimumHealthyHosts')
    -> TF.Attr s P.Text -- ^ @deployment_config_name@ ('P._deploymentConfigName', 'P.deploymentConfigName')
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_minimumHealthyHosts"
                  (_minimumHealthyHosts
                      :: CodedeployDeploymentConfigResource s -> TF.Attr s (CodedeployDeploymentConfigMinimumHealthyHostsSetting s))
                  TF.validator
...
instance P.HasMinimumHealthyHosts (CodedeployDeploymentConfigResource s) (TF.Attr s (CodedeployDeploymentConfigMinimumHealthyHostsSetting s)) where
    minimumHealthyHosts =
        P.lens (_minimumHealthyHosts :: CodedeployDeploymentConfigResource s -> TF.Attr s (CodedeployDeploymentConfigMinimumHealthyHostsSetting s))
...
data CodedeployDeploymentGroupResource s = CodedeployDeploymentGroupResource'
    { _alarmConfiguration :: TF.Attr s (CodedeployDeploymentGroupAlarmConfigurationSetting s)
    -- ^ @alarm_configuration@ - (Optional)
    --
    , _appName :: TF.Attr s P.Text
    -- ^ @app_name@ - (Required)
    --
    , _autoRollbackConfiguration :: TF.Attr s (CodedeployDeploymentGroupAutoRollbackConfigurationSetting s)
    -- ^ @auto_rollback_configuration@ - (Optional)
    --
    , _autoscalingGroups :: TF.Attr s [TF.Attr s P.Text]
    -- ^ @autoscaling_groups@ - (Optional)
    --
    , _blueGreenDeploymentConfig :: TF.Attr s (CodedeployDeploymentGroupBlueGreenDeploymentConfigSetting s)
    ...
    --
    , _deploymentStyle :: TF.Attr s (CodedeployDeploymentGroupDeploymentStyleSetting s)
    -- ^ @deployment_style@ - (Optional)
    --
    , _ec2TagFilter :: TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagFilterSetting s)]
    -- ^ @ec2_tag_filter@ - (Optional)
    --
    , _ec2TagSet :: TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagSetSetting s)]
    -- ^ @ec2_tag_set@ - (Optional)
    --
    , _loadBalancerInfo :: TF.Attr s (CodedeployDeploymentGroupLoadBalancerInfoSetting s)
    -- ^ @load_balancer_info@ - (Optional)
    --
    , _onPremisesInstanceTagFilter :: TF.Attr s [TF.Attr s (CodedeployDeploymentGroupOnPremisesInstanceTagFilterSetting s)]
    -- ^ @on_premises_instance_tag_filter@ - (Optional)
    --
    , _serviceRoleArn :: TF.Attr s P.Text
    -- ^ @service_role_arn@ - (Required)
    --
    , _triggerConfiguration :: TF.Attr s [TF.Attr s (CodedeployDeploymentGroupTriggerConfigurationSetting s)]
...
codedeployDeploymentGroupResource
    ...
    -> TF.Attr s P.Text -- ^ @app_name@ ('P._appName', 'P.appName')
    -> TF.Attr s P.Text -- ^ @deployment_group_name@ ('P._deploymentGroupName', 'P.deploymentGroupName')
...
instance TF.IsValid (CodedeployDeploymentGroupResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_alarmConfiguration"
                  (_alarmConfiguration
                      :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupAlarmConfigurationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_autoRollbackConfiguration"
                  (_autoRollbackConfiguration
                      :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupAutoRollbackConfigurationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_blueGreenDeploymentConfig"
                  (_blueGreenDeploymentConfig
                      :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupBlueGreenDeploymentConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_deploymentStyle"
                  (_deploymentStyle
                      :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupDeploymentStyleSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_loadBalancerInfo"
                  (_loadBalancerInfo
                      :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupLoadBalancerInfoSetting s))
                  TF.validator

instance P.HasAlarmConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s (CodedeployDeploymentGroupAlarmConfigurationSetting s)) where
    alarmConfiguration =
        P.lens (_alarmConfiguration :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupAlarmConfigurationSetting s))
...
instance P.HasAutoRollbackConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s (CodedeployDeploymentGroupAutoRollbackConfigurationSetting s)) where
    autoRollbackConfiguration =
        P.lens (_autoRollbackConfiguration :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupAutoRollbackConfigurationSetting s))
...
instance P.HasBlueGreenDeploymentConfig (CodedeployDeploymentGroupResource s) (TF.Attr s (CodedeployDeploymentGroupBlueGreenDeploymentConfigSetting s)) where
    blueGreenDeploymentConfig =
        P.lens (_blueGreenDeploymentConfig :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupBlueGreenDeploymentConfigSetting s))
...
instance P.HasDeploymentStyle (CodedeployDeploymentGroupResource s) (TF.Attr s (CodedeployDeploymentGroupDeploymentStyleSetting s)) where
    deploymentStyle =
        P.lens (_deploymentStyle :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupDeploymentStyleSetting s))
               (\s a -> s { _deploymentStyle = a } :: CodedeployDeploymentGroupResource s)

instance P.HasEc2TagFilter (CodedeployDeploymentGroupResource s) (TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagFilterSetting s)]) where
    ec2TagFilter =
        P.lens (_ec2TagFilter :: CodedeployDeploymentGroupResource s -> TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagFilterSetting s)])
               (\s a -> s { _ec2TagFilter = a } :: CodedeployDeploymentGroupResource s)

instance P.HasEc2TagSet (CodedeployDeploymentGroupResource s) (TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagSetSetting s)]) where
    ec2TagSet =
        P.lens (_ec2TagSet :: CodedeployDeploymentGroupResource s -> TF.Attr s [TF.Attr s (CodedeployDeploymentGroupEc2TagSetSetting s)])
               (\s a -> s { _ec2TagSet = a } :: CodedeployDeploymentGroupResource s)

instance P.HasLoadBalancerInfo (CodedeployDeploymentGroupResource s) (TF.Attr s (CodedeployDeploymentGroupLoadBalancerInfoSetting s)) where
    loadBalancerInfo =
        P.lens (_loadBalancerInfo :: CodedeployDeploymentGroupResource s -> TF.Attr s (CodedeployDeploymentGroupLoadBalancerInfoSetting s))
               (\s a -> s { _loadBalancerInfo = a } :: CodedeployDeploymentGroupResource s)

instance P.HasOnPremisesInstanceTagFilter (CodedeployDeploymentGroupResource s) (TF.Attr s [TF.Attr s (CodedeployDeploymentGroupOnPremisesInstanceTagFilterSetting s)]) where
    onPremisesInstanceTagFilter =
        P.lens (_onPremisesInstanceTagFilter :: CodedeployDeploymentGroupResource s -> TF.Attr s [TF.Attr s (CodedeployDeploymentGroupOnPremisesInstanceTagFilterSetting s)])
...
instance P.HasTriggerConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s [TF.Attr s (CodedeployDeploymentGroupTriggerConfigurationSetting s)]) where
    triggerConfiguration =
        P.lens (_triggerConfiguration :: CodedeployDeploymentGroupResource s -> TF.Attr s [TF.Attr s (CodedeployDeploymentGroupTriggerConfigurationSetting s)])
...
instance s ~ s' => P.HasComputedBlueGreenDeploymentConfig (TF.Ref s' (CodedeployDeploymentGroupResource s)) (TF.Attr s (CodedeployDeploymentGroupBlueGreenDeploymentConfigSetting s)) where
    computedBlueGreenDeploymentConfig x = TF.compute (TF.refKey x) "blue_green_deployment_config"

instance s ~ s' => P.HasComputedDeploymentStyle (TF.Ref s' (CodedeployDeploymentGroupResource s)) (TF.Attr s (CodedeployDeploymentGroupDeploymentStyleSetting s)) where
    computedDeploymentStyle x = TF.compute (TF.refKey x) "deployment_style"

instance s ~ s' => P.HasComputedLoadBalancerInfo (TF.Ref s' (CodedeployDeploymentGroupResource s)) (TF.Attr s (CodedeployDeploymentGroupLoadBalancerInfoSetting s)) where
...
data CodepipelineResource s = CodepipelineResource'
    { _artifactStore :: TF.Attr s (CodepipelineArtifactStoreSetting s)
    ...
    -- ^ @role_arn@ - (Required)
    --
    , _stage :: TF.Attr s (P.NonEmpty (TF.Attr s (CodepipelineStageSetting s)))
    -- ^ @stage@ - (Required)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
codepipelineResource
    :: TF.Attr s P.Text -- ^ @role_arn@ ('P._roleArn', 'P.roleArn')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s (P.NonEmpty (TF.Attr s (CodepipelineStageSetting s))) -- ^ @stage@ ('P._stage', 'P.stage')
    -> TF.Attr s (CodepipelineArtifactStoreSetting s) -- ^ @artifact_store@ ('P._artifactStore', 'P.artifactStore')
...
instance TF.IsValid (CodepipelineResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_artifactStore"
                  (_artifactStore
                      :: CodepipelineResource s -> TF.Attr s (CodepipelineArtifactStoreSetting s))
                  TF.validator

instance P.HasArtifactStore (CodepipelineResource s) (TF.Attr s (CodepipelineArtifactStoreSetting s)) where
    artifactStore =
        P.lens (_artifactStore :: CodepipelineResource s -> TF.Attr s (CodepipelineArtifactStoreSetting s))
...
instance P.HasStage (CodepipelineResource s) (TF.Attr s (P.NonEmpty (TF.Attr s (CodepipelineStageSetting s)))) where
    stage =
        P.lens (_stage :: CodepipelineResource s -> TF.Attr s (P.NonEmpty (TF.Attr s (CodepipelineStageSetting s))))
...
data CognitoIdentityPoolResource s = CognitoIdentityPoolResource'
    ...
    --
    , _cognitoIdentityProviders :: TF.Attr s [TF.Attr s (CognitoIdentityPoolCognitoIdentityProvidersSetting s)]
...
cognitoIdentityPoolResource
    :: TF.Attr s P.Text -- ^ @identity_pool_name@ ('P._identityPoolName', 'P.identityPoolName')
...
instance P.HasCognitoIdentityProviders (CognitoIdentityPoolResource s) (TF.Attr s [TF.Attr s (CognitoIdentityPoolCognitoIdentityProvidersSetting s)]) where
    cognitoIdentityProviders =
        P.lens (_cognitoIdentityProviders :: CognitoIdentityPoolResource s -> TF.Attr s [TF.Attr s (CognitoIdentityPoolCognitoIdentityProvidersSetting s)])
...
data CognitoIdentityPoolRolesAttachmentResource s = CognitoIdentityPoolRolesAttachmentResource'
    ...
    --
    , _roleMapping :: TF.Attr s [TF.Attr s (CognitoIdentityPoolRolesAttachmentRoleMappingSetting s)]
    -- ^ @role_mapping@ - (Optional)
    --
    , _roles :: TF.Attr s (P.Map P.Text (TF.Attr s (CognitoIdentityPoolRolesAttachmentRolesSetting s)))
...
cognitoIdentityPoolRolesAttachmentResource
    :: TF.Attr s P.Text -- ^ @identity_pool_id@ ('P._identityPoolId', 'P.identityPoolId')
    -> TF.Attr s (P.Map P.Text (TF.Attr s (CognitoIdentityPoolRolesAttachmentRolesSetting s))) -- ^ @roles@ ('P._roles', 'P.roles')
...
instance P.HasRoleMapping (CognitoIdentityPoolRolesAttachmentResource s) (TF.Attr s [TF.Attr s (CognitoIdentityPoolRolesAttachmentRoleMappingSetting s)]) where
    roleMapping =
        P.lens (_roleMapping :: CognitoIdentityPoolRolesAttachmentResource s -> TF.Attr s [TF.Attr s (CognitoIdentityPoolRolesAttachmentRoleMappingSetting s)])
               (\s a -> s { _roleMapping = a } :: CognitoIdentityPoolRolesAttachmentResource s)

instance P.HasRoles (CognitoIdentityPoolRolesAttachmentResource s) (TF.Attr s (P.Map P.Text (TF.Attr s (CognitoIdentityPoolRolesAttachmentRolesSetting s)))) where
    roles =
        P.lens (_roles :: CognitoIdentityPoolRolesAttachmentResource s -> TF.Attr s (P.Map P.Text (TF.Attr s (CognitoIdentityPoolRolesAttachmentRolesSetting s))))
