...
data SesReceiptRuleResource s = SesReceiptRuleResource'
    { _addHeaderAction :: TF.Attr s [TF.Attr s (SesReceiptRuleAddHeaderActionSetting s)]
    -- ^ @add_header_action@ - (Optional)
    --
    , _after :: TF.Attr s P.Text
    -- ^ @after@ - (Optional)
    --
    , _bounceAction :: TF.Attr s [TF.Attr s (SesReceiptRuleBounceActionSetting s)]
    -- ^ @bounce_action@ - (Optional)
    --
    , _enabled :: TF.Attr s P.Bool
    -- ^ @enabled@ - (Optional)
    --
    , _lambdaAction :: TF.Attr s [TF.Attr s (SesReceiptRuleLambdaActionSetting s)]
    ...
    --
    , _s3Action :: TF.Attr s [TF.Attr s (SesReceiptRuleS3ActionSetting s)]
    -- ^ @s3_action@ - (Optional)
    --
    , _scanEnabled :: TF.Attr s P.Bool
    -- ^ @scan_enabled@ - (Optional)
    --
    , _snsAction :: TF.Attr s [TF.Attr s (SesReceiptRuleSnsActionSetting s)]
    -- ^ @sns_action@ - (Optional)
    --
    , _stopAction :: TF.Attr s [TF.Attr s (SesReceiptRuleStopActionSetting s)]
    -- ^ @stop_action@ - (Optional)
    --
    , _tlsPolicy :: TF.Attr s P.Text
    -- ^ @tls_policy@ - (Optional)
    --
    , _workmailAction :: TF.Attr s [TF.Attr s (SesReceiptRuleWorkmailActionSetting s)]
...
instance P.HasAddHeaderAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleAddHeaderActionSetting s)]) where
    addHeaderAction =
        P.lens (_addHeaderAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleAddHeaderActionSetting s)])
...
instance P.HasBounceAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleBounceActionSetting s)]) where
    bounceAction =
        P.lens (_bounceAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleBounceActionSetting s)])
...
instance P.HasLambdaAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleLambdaActionSetting s)]) where
    lambdaAction =
        P.lens (_lambdaAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleLambdaActionSetting s)])
...
instance P.HasS3Action (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleS3ActionSetting s)]) where
    s3Action =
        P.lens (_s3Action :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleS3ActionSetting s)])
...
instance P.HasSnsAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleSnsActionSetting s)]) where
    snsAction =
        P.lens (_snsAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleSnsActionSetting s)])
               (\s a -> s { _snsAction = a } :: SesReceiptRuleResource s)

instance P.HasStopAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleStopActionSetting s)]) where
    stopAction =
        P.lens (_stopAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleStopActionSetting s)])
...
instance P.HasWorkmailAction (SesReceiptRuleResource s) (TF.Attr s [TF.Attr s (SesReceiptRuleWorkmailActionSetting s)]) where
    workmailAction =
        P.lens (_workmailAction :: SesReceiptRuleResource s -> TF.Attr s [TF.Attr s (SesReceiptRuleWorkmailActionSetting s)])
...
spotFleetRequestResource
    ...
    -> TF.Attr s [TF.Attr s (SpotFleetRequestLaunchSpecificationSetting s)] -- ^ @launch_specification@ ('P._launchSpecification', 'P.launchSpecification')
...
instance P.HasLaunchSpecification (SpotFleetRequestResource s) (TF.Attr s [TF.Attr s (SpotFleetRequestLaunchSpecificationSetting s)]) where
    launchSpecification =
        P.lens (_launchSpecification :: SpotFleetRequestResource s -> TF.Attr s [TF.Attr s (SpotFleetRequestLaunchSpecificationSetting s)])
...
data SpotInstanceRequestResource s = SpotInstanceRequestResource'
    ...
    --
    , _creditSpecification :: TF.Attr s (SpotInstanceRequestCreditSpecificationSetting s)
    ...
    --
    , _ebsBlockDevice :: TF.Attr s [TF.Attr s (SpotInstanceRequestEbsBlockDeviceSetting s)]
    -- ^ @ebs_block_device@ - (Optional, Forces New)
    --
    , _ebsOptimized :: TF.Attr s P.Bool
    -- ^ @ebs_optimized@ - (Optional, Forces New)
    --
    , _ephemeralBlockDevice :: TF.Attr s [TF.Attr s (SpotInstanceRequestEphemeralBlockDeviceSetting s)]
    ...
    --
    , _networkInterface :: TF.Attr s [TF.Attr s (SpotInstanceRequestNetworkInterfaceSetting s)]
    ...
    --
    -- * 'networkInterface'
    , _rootBlockDevice :: TF.Attr s (SpotInstanceRequestRootBlockDeviceSetting s)
        ...
        , if (_vpcSecurityGroupIds P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_creditSpecification"
                  (_creditSpecification
                      :: SpotInstanceRequestResource s -> TF.Attr s (SpotInstanceRequestCreditSpecificationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_rootBlockDevice"
                  (_rootBlockDevice
                      :: SpotInstanceRequestResource s -> TF.Attr s (SpotInstanceRequestRootBlockDeviceSetting s))
                  TF.validator
...
instance P.HasCreditSpecification (SpotInstanceRequestResource s) (TF.Attr s (SpotInstanceRequestCreditSpecificationSetting s)) where
    creditSpecification =
        P.lens (_creditSpecification :: SpotInstanceRequestResource s -> TF.Attr s (SpotInstanceRequestCreditSpecificationSetting s))
...
instance P.HasEbsBlockDevice (SpotInstanceRequestResource s) (TF.Attr s [TF.Attr s (SpotInstanceRequestEbsBlockDeviceSetting s)]) where
    ebsBlockDevice =
        P.lens (_ebsBlockDevice :: SpotInstanceRequestResource s -> TF.Attr s [TF.Attr s (SpotInstanceRequestEbsBlockDeviceSetting s)])
...
instance P.HasEphemeralBlockDevice (SpotInstanceRequestResource s) (TF.Attr s [TF.Attr s (SpotInstanceRequestEphemeralBlockDeviceSetting s)]) where
    ephemeralBlockDevice =
        P.lens (_ephemeralBlockDevice :: SpotInstanceRequestResource s -> TF.Attr s [TF.Attr s (SpotInstanceRequestEphemeralBlockDeviceSetting s)])
...
instance P.HasNetworkInterface (SpotInstanceRequestResource s) (TF.Attr s [TF.Attr s (SpotInstanceRequestNetworkInterfaceSetting s)]) where
    networkInterface =
        P.lens (_networkInterface :: SpotInstanceRequestResource s -> TF.Attr s [TF.Attr s (SpotInstanceRequestNetworkInterfaceSetting s)])
...
instance P.HasRootBlockDevice (SpotInstanceRequestResource s) (TF.Attr s (SpotInstanceRequestRootBlockDeviceSetting s)) where
    rootBlockDevice =
        P.lens (_rootBlockDevice :: SpotInstanceRequestResource s -> TF.Attr s (SpotInstanceRequestRootBlockDeviceSetting s))
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (SpotInstanceRequestResource s)) (TF.Attr s [TF.Attr s (SpotInstanceRequestEbsBlockDeviceSetting s)]) where
    computedEbsBlockDevice x = TF.compute (TF.refKey x) "ebs_block_device"

instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (SpotInstanceRequestResource s)) (TF.Attr s [TF.Attr s (SpotInstanceRequestEphemeralBlockDeviceSetting s)]) where
...
instance s ~ s' => P.HasComputedNetworkInterface (TF.Ref s' (SpotInstanceRequestResource s)) (TF.Attr s [TF.Attr s (SpotInstanceRequestNetworkInterfaceSetting s)]) where
...
instance s ~ s' => P.HasComputedRootBlockDevice (TF.Ref s' (SpotInstanceRequestResource s)) (TF.Attr s (SpotInstanceRequestRootBlockDeviceSetting s)) where
...
data SsmAssociationResource s = SsmAssociationResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _outputLocation :: TF.Attr s (SsmAssociationOutputLocationSetting s)
    ...
    --
    , _targets :: TF.Attr s [TF.Attr s (SsmAssociationTargetsSetting s)]
    -- ^ @targets@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance TF.IsValid (SsmAssociationResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_outputLocation"
                  (_outputLocation
                      :: SsmAssociationResource s -> TF.Attr s (SsmAssociationOutputLocationSetting s))
                  TF.validator
...
instance P.HasOutputLocation (SsmAssociationResource s) (TF.Attr s (SsmAssociationOutputLocationSetting s)) where
    outputLocation =
        P.lens (_outputLocation :: SsmAssociationResource s -> TF.Attr s (SsmAssociationOutputLocationSetting s))
...
instance P.HasTargets (SsmAssociationResource s) (TF.Attr s [TF.Attr s (SsmAssociationTargetsSetting s)]) where
    targets =
        P.lens (_targets :: SsmAssociationResource s -> TF.Attr s [TF.Attr s (SsmAssociationTargetsSetting s)])
...
instance s ~ s' => P.HasComputedTargets (TF.Ref s' (SsmAssociationResource s)) (TF.Attr s [TF.Attr s (SsmAssociationTargetsSetting s)]) where
...
data SsmDocumentResource s = SsmDocumentResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _permissions :: TF.Attr s (P.Map P.Text (TF.Attr s (SsmDocumentPermissionsSetting s)))
...
instance P.HasPermissions (SsmDocumentResource s) (TF.Attr s (P.Map P.Text (TF.Attr s (SsmDocumentPermissionsSetting s)))) where
    permissions =
        P.lens (_permissions :: SsmDocumentResource s -> TF.Attr s (P.Map P.Text (TF.Attr s (SsmDocumentPermissionsSetting s))))
...
instance s ~ s' => P.HasComputedParameter (TF.Ref s' (SsmDocumentResource s)) (TF.Attr s [TF.Attr s (SsmDocumentParameterSetting s)]) where
...
data SsmMaintenanceWindowTargetResource s = SsmMaintenanceWindowTargetResource'
    ...
    --
    , _targets :: TF.Attr s [TF.Attr s (SsmMaintenanceWindowTargetTargetsSetting s)]
    -- ^ @targets@ - (Required)
    --
...
ssmMaintenanceWindowTargetResource
    ...
    -> TF.Attr s [TF.Attr s (SsmMaintenanceWindowTargetTargetsSetting s)] -- ^ @targets@ ('P._targets', 'P.targets')
...
instance P.HasTargets (SsmMaintenanceWindowTargetResource s) (TF.Attr s [TF.Attr s (SsmMaintenanceWindowTargetTargetsSetting s)]) where
    targets =
        P.lens (_targets :: SsmMaintenanceWindowTargetResource s -> TF.Attr s [TF.Attr s (SsmMaintenanceWindowTargetTargetsSetting s)])
...
data SsmMaintenanceWindowTaskResource s = SsmMaintenanceWindowTaskResource'
    { _loggingInfo :: TF.Attr s (SsmMaintenanceWindowTaskLoggingInfoSetting s)
    ...
    --
    , _targets :: TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTargetsSetting s)]
    -- ^ @targets@ - (Required, Forces New)
    --
    , _taskArn :: TF.Attr s P.Text
    -- ^ @task_arn@ - (Required, Forces New)
    --
    , _taskParameters :: TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTaskParametersSetting s)]
...
ssmMaintenanceWindowTaskResource
    ...
    -> TF.Attr s P.Text -- ^ @window_id@ ('P._windowId', 'P.windowId')
    -> TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTargetsSetting s)] -- ^ @targets@ ('P._targets', 'P.targets')
...
instance TF.IsValid (SsmMaintenanceWindowTaskResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_loggingInfo"
                  (_loggingInfo
                      :: SsmMaintenanceWindowTaskResource s -> TF.Attr s (SsmMaintenanceWindowTaskLoggingInfoSetting s))
                  TF.validator

instance P.HasLoggingInfo (SsmMaintenanceWindowTaskResource s) (TF.Attr s (SsmMaintenanceWindowTaskLoggingInfoSetting s)) where
    loggingInfo =
        P.lens (_loggingInfo :: SsmMaintenanceWindowTaskResource s -> TF.Attr s (SsmMaintenanceWindowTaskLoggingInfoSetting s))
...
instance P.HasTargets (SsmMaintenanceWindowTaskResource s) (TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTargetsSetting s)]) where
    targets =
        P.lens (_targets :: SsmMaintenanceWindowTaskResource s -> TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTargetsSetting s)])
...
instance P.HasTaskParameters (SsmMaintenanceWindowTaskResource s) (TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTaskParametersSetting s)]) where
    taskParameters =
        P.lens (_taskParameters :: SsmMaintenanceWindowTaskResource s -> TF.Attr s [TF.Attr s (SsmMaintenanceWindowTaskTaskParametersSetting s)])
...
data SsmPatchBaselineResource s = SsmPatchBaselineResource'
    { _approvalRule :: TF.Attr s [TF.Attr s (SsmPatchBaselineApprovalRuleSetting s)]
    ...
    -- ^ @description@ - (Optional)
    --
    , _globalFilter :: TF.Attr s [TF.Attr s (SsmPatchBaselineGlobalFilterSetting s)]
...
instance P.HasApprovalRule (SsmPatchBaselineResource s) (TF.Attr s [TF.Attr s (SsmPatchBaselineApprovalRuleSetting s)]) where
    approvalRule =
        P.lens (_approvalRule :: SsmPatchBaselineResource s -> TF.Attr s [TF.Attr s (SsmPatchBaselineApprovalRuleSetting s)])
...
instance P.HasGlobalFilter (SsmPatchBaselineResource s) (TF.Attr s [TF.Attr s (SsmPatchBaselineGlobalFilterSetting s)]) where
    globalFilter =
        P.lens (_globalFilter :: SsmPatchBaselineResource s -> TF.Attr s [TF.Attr s (SsmPatchBaselineGlobalFilterSetting s)])
...
data SsmResourceDataSyncResource s = SsmResourceDataSyncResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _s3Destination :: TF.Attr s (SsmResourceDataSyncS3DestinationSetting s)
...
ssmResourceDataSyncResource
    :: TF.Attr s (SsmResourceDataSyncS3DestinationSetting s) -- ^ @s3_destination@ ('P._s3Destination', 'P.s3Destination')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance TF.IsValid (SsmResourceDataSyncResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_s3Destination"
                  (_s3Destination
                      :: SsmResourceDataSyncResource s -> TF.Attr s (SsmResourceDataSyncS3DestinationSetting s))
                  TF.validator
...
instance P.HasS3Destination (SsmResourceDataSyncResource s) (TF.Attr s (SsmResourceDataSyncS3DestinationSetting s)) where
    s3Destination =
        P.lens (_s3Destination :: SsmResourceDataSyncResource s -> TF.Attr s (SsmResourceDataSyncS3DestinationSetting s))
...
data StoragegatewayGatewayResource s = StoragegatewayGatewayResource'
    ...
    --
    , _smbActiveDirectorySettings :: TF.Attr s (StoragegatewayGatewaySmbActiveDirectorySettingsSetting s)
        ...
        , if (_gatewayIpAddress P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_smbActiveDirectorySettings"
                  (_smbActiveDirectorySettings
                      :: StoragegatewayGatewayResource s -> TF.Attr s (StoragegatewayGatewaySmbActiveDirectorySettingsSetting s))
                  TF.validator
...
instance P.HasSmbActiveDirectorySettings (StoragegatewayGatewayResource s) (TF.Attr s (StoragegatewayGatewaySmbActiveDirectorySettingsSetting s)) where
    smbActiveDirectorySettings =
        P.lens (_smbActiveDirectorySettings :: StoragegatewayGatewayResource s -> TF.Attr s (StoragegatewayGatewaySmbActiveDirectorySettingsSetting s))
...
data StoragegatewayNfsFileShareResource s = StoragegatewayNfsFileShareResource'
    ...
    --
    , _nfsFileShareDefaults :: TF.Attr s (StoragegatewayNfsFileShareNfsFileShareDefaultsSetting s)
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_nfsFileShareDefaults"
                  (_nfsFileShareDefaults
                      :: StoragegatewayNfsFileShareResource s -> TF.Attr s (StoragegatewayNfsFileShareNfsFileShareDefaultsSetting s))
                  TF.validator
...
instance P.HasNfsFileShareDefaults (StoragegatewayNfsFileShareResource s) (TF.Attr s (StoragegatewayNfsFileShareNfsFileShareDefaultsSetting s)) where
    nfsFileShareDefaults =
        P.lens (_nfsFileShareDefaults :: StoragegatewayNfsFileShareResource s -> TF.Attr s (StoragegatewayNfsFileShareNfsFileShareDefaultsSetting s))
...
instance s ~ s' => P.HasComputedDnsEntry (TF.Ref s' (VpcEndpointResource s)) (TF.Attr s [TF.Attr s (VpcEndpointDnsEntrySetting s)]) where
...
data VpcPeeringConnectionAccepterResource s = VpcPeeringConnectionAccepterResource'
    { _accepter :: TF.Attr s (VpcPeeringConnectionAccepterAccepterSetting s)
    -- ^ @accepter@ - (Optional)
    --
    , _autoAccept :: TF.Attr s P.Bool
    -- ^ @auto_accept@ - (Optional)
    --
    , _requester :: TF.Attr s (VpcPeeringConnectionAccepterRequesterSetting s)
    -- ^ @requester@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance TF.IsValid (VpcPeeringConnectionAccepterResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_accepter"
                  (_accepter
                      :: VpcPeeringConnectionAccepterResource s -> TF.Attr s (VpcPeeringConnectionAccepterAccepterSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_requester"
                  (_requester
                      :: VpcPeeringConnectionAccepterResource s -> TF.Attr s (VpcPeeringConnectionAccepterRequesterSetting s))
                  TF.validator

instance P.HasAccepter (VpcPeeringConnectionAccepterResource s) (TF.Attr s (VpcPeeringConnectionAccepterAccepterSetting s)) where
    accepter =
        P.lens (_accepter :: VpcPeeringConnectionAccepterResource s -> TF.Attr s (VpcPeeringConnectionAccepterAccepterSetting s))
...
instance P.HasRequester (VpcPeeringConnectionAccepterResource s) (TF.Attr s (VpcPeeringConnectionAccepterRequesterSetting s)) where
    requester =
        P.lens (_requester :: VpcPeeringConnectionAccepterResource s -> TF.Attr s (VpcPeeringConnectionAccepterRequesterSetting s))
...
instance s ~ s' => P.HasComputedAccepter (TF.Ref s' (VpcPeeringConnectionAccepterResource s)) (TF.Attr s (VpcPeeringConnectionAccepterAccepterSetting s)) where
...
instance s ~ s' => P.HasComputedRequester (TF.Ref s' (VpcPeeringConnectionAccepterResource s)) (TF.Attr s (VpcPeeringConnectionAccepterRequesterSetting s)) where
...
data VpcPeeringConnectionOptionsResource s = VpcPeeringConnectionOptionsResource'
    { _accepter :: TF.Attr s (VpcPeeringConnectionOptionsAccepterSetting s)
    -- ^ @accepter@ - (Optional)
    --
    , _requester :: TF.Attr s (VpcPeeringConnectionOptionsRequesterSetting s)
    -- ^ @requester@ - (Optional)
    --
    , _vpcPeeringConnectionId :: TF.Attr s P.Text
    -- ^ @vpc_peering_connection_id@ - (Required, Forces New)
...
instance TF.IsValid (VpcPeeringConnectionOptionsResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_accepter"
                  (_accepter
                      :: VpcPeeringConnectionOptionsResource s -> TF.Attr s (VpcPeeringConnectionOptionsAccepterSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_requester"
                  (_requester
                      :: VpcPeeringConnectionOptionsResource s -> TF.Attr s (VpcPeeringConnectionOptionsRequesterSetting s))
                  TF.validator

instance P.HasAccepter (VpcPeeringConnectionOptionsResource s) (TF.Attr s (VpcPeeringConnectionOptionsAccepterSetting s)) where
    accepter =
        P.lens (_accepter :: VpcPeeringConnectionOptionsResource s -> TF.Attr s (VpcPeeringConnectionOptionsAccepterSetting s))
               (\s a -> s { _accepter = a } :: VpcPeeringConnectionOptionsResource s)

instance P.HasRequester (VpcPeeringConnectionOptionsResource s) (TF.Attr s (VpcPeeringConnectionOptionsRequesterSetting s)) where
    requester =
        P.lens (_requester :: VpcPeeringConnectionOptionsResource s -> TF.Attr s (VpcPeeringConnectionOptionsRequesterSetting s))
...
instance s ~ s' => P.HasComputedAccepter (TF.Ref s' (VpcPeeringConnectionOptionsResource s)) (TF.Attr s (VpcPeeringConnectionOptionsAccepterSetting s)) where
    computedAccepter x = TF.compute (TF.refKey x) "accepter"

instance s ~ s' => P.HasComputedRequester (TF.Ref s' (VpcPeeringConnectionOptionsResource s)) (TF.Attr s (VpcPeeringConnectionOptionsRequesterSetting s)) where
    computedRequester x = TF.compute (TF.refKey x) "requester"
...
data VpcPeeringConnectionResource s = VpcPeeringConnectionResource'
    { _accepter    :: TF.Attr s (VpcPeeringConnectionAccepterSetting s)
    -- ^ @accepter@ - (Optional)
    --
    , _autoAccept  :: TF.Attr s P.Bool
    -- ^ @auto_accept@ - (Optional)
    ...
    --
    , _requester   :: TF.Attr s (VpcPeeringConnectionRequesterSetting s)
    -- ^ @requester@ - (Optional)
    --
    , _tags        :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance TF.IsValid (VpcPeeringConnectionResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_accepter"
                  (_accepter
                      :: VpcPeeringConnectionResource s -> TF.Attr s (VpcPeeringConnectionAccepterSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_requester"
                  (_requester
                      :: VpcPeeringConnectionResource s -> TF.Attr s (VpcPeeringConnectionRequesterSetting s))
                  TF.validator

instance P.HasAccepter (VpcPeeringConnectionResource s) (TF.Attr s (VpcPeeringConnectionAccepterSetting s)) where
    accepter =
        P.lens (_accepter :: VpcPeeringConnectionResource s -> TF.Attr s (VpcPeeringConnectionAccepterSetting s))
...
instance P.HasRequester (VpcPeeringConnectionResource s) (TF.Attr s (VpcPeeringConnectionRequesterSetting s)) where
    requester =
        P.lens (_requester :: VpcPeeringConnectionResource s -> TF.Attr s (VpcPeeringConnectionRequesterSetting s))
...
instance s ~ s' => P.HasComputedAccepter (TF.Ref s' (VpcPeeringConnectionResource s)) (TF.Attr s (VpcPeeringConnectionAccepterSetting s)) where
    computedAccepter x = TF.compute (TF.refKey x) "accepter"
...
instance s ~ s' => P.HasComputedRequester (TF.Ref s' (VpcPeeringConnectionResource s)) (TF.Attr s (VpcPeeringConnectionRequesterSetting s)) where
    computedRequester x = TF.compute (TF.refKey x) "requester"
...
data VpnConnectionResource s = VpnConnectionResource'
    ...
    --
    , _routes :: TF.Attr s [TF.Attr s (VpnConnectionRoutesSetting s)]
    -- ^ @routes@ - (Optional)
    --
    ...
    --
    , _vgwTelemetry :: TF.Attr s [TF.Attr s (VpnConnectionVgwTelemetrySetting s)]
...
instance P.HasRoutes (VpnConnectionResource s) (TF.Attr s [TF.Attr s (VpnConnectionRoutesSetting s)]) where
    routes =
        P.lens (_routes :: VpnConnectionResource s -> TF.Attr s [TF.Attr s (VpnConnectionRoutesSetting s)])
...
instance P.HasVgwTelemetry (VpnConnectionResource s) (TF.Attr s [TF.Attr s (VpnConnectionVgwTelemetrySetting s)]) where
    vgwTelemetry =
        P.lens (_vgwTelemetry :: VpnConnectionResource s -> TF.Attr s [TF.Attr s (VpnConnectionVgwTelemetrySetting s)])
...
instance s ~ s' => P.HasComputedRoutes (TF.Ref s' (VpnConnectionResource s)) (TF.Attr s [TF.Attr s (VpnConnectionRoutesSetting s)]) where
...
instance s ~ s' => P.HasComputedVgwTelemetry (TF.Ref s' (VpnConnectionResource s)) (TF.Attr s [TF.Attr s (VpnConnectionVgwTelemetrySetting s)]) where
...
data WafByteMatchSetResource s = WafByteMatchSetResource'
    { _byteMatchTuples :: TF.Attr s [TF.Attr s (WafByteMatchSetByteMatchTuplesSetting s)]
...
instance P.HasByteMatchTuples (WafByteMatchSetResource s) (TF.Attr s [TF.Attr s (WafByteMatchSetByteMatchTuplesSetting s)]) where
    byteMatchTuples =
        P.lens (_byteMatchTuples :: WafByteMatchSetResource s -> TF.Attr s [TF.Attr s (WafByteMatchSetByteMatchTuplesSetting s)])
...
data WafGeoMatchSetResource s = WafGeoMatchSetResource'
    { _geoMatchConstraint :: TF.Attr s [TF.Attr s (WafGeoMatchSetGeoMatchConstraintSetting s)]
...
instance P.HasGeoMatchConstraint (WafGeoMatchSetResource s) (TF.Attr s [TF.Attr s (WafGeoMatchSetGeoMatchConstraintSetting s)]) where
    geoMatchConstraint =
        P.lens (_geoMatchConstraint :: WafGeoMatchSetResource s -> TF.Attr s [TF.Attr s (WafGeoMatchSetGeoMatchConstraintSetting s)])
...
data WafIpsetResource s = WafIpsetResource'
    { _ipSetDescriptors :: TF.Attr s [TF.Attr s (WafIpsetIpSetDescriptorsSetting s)]
...
instance P.HasIpSetDescriptors (WafIpsetResource s) (TF.Attr s [TF.Attr s (WafIpsetIpSetDescriptorsSetting s)]) where
    ipSetDescriptors =
        P.lens (_ipSetDescriptors :: WafIpsetResource s -> TF.Attr s [TF.Attr s (WafIpsetIpSetDescriptorsSetting s)])
...
data WafRateBasedRuleResource s = WafRateBasedRuleResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _predicates :: TF.Attr s [TF.Attr s (WafRateBasedRulePredicatesSetting s)]
    -- ^ @predicates@ - (Optional)
    --
...
instance P.HasPredicates (WafRateBasedRuleResource s) (TF.Attr s [TF.Attr s (WafRateBasedRulePredicatesSetting s)]) where
    predicates =
        P.lens (_predicates :: WafRateBasedRuleResource s -> TF.Attr s [TF.Attr s (WafRateBasedRulePredicatesSetting s)])
...
data WafRegexMatchSetResource s = WafRegexMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _regexMatchTuple :: TF.Attr s [TF.Attr s (WafRegexMatchSetRegexMatchTupleSetting s)]
...
instance P.HasRegexMatchTuple (WafRegexMatchSetResource s) (TF.Attr s [TF.Attr s (WafRegexMatchSetRegexMatchTupleSetting s)]) where
    regexMatchTuple =
        P.lens (_regexMatchTuple :: WafRegexMatchSetResource s -> TF.Attr s [TF.Attr s (WafRegexMatchSetRegexMatchTupleSetting s)])
...
data WafRuleGroupResource s = WafRuleGroupResource'
    { _activatedRule :: TF.Attr s [TF.Attr s (WafRuleGroupActivatedRuleSetting s)]
...
instance P.HasActivatedRule (WafRuleGroupResource s) (TF.Attr s [TF.Attr s (WafRuleGroupActivatedRuleSetting s)]) where
    activatedRule =
        P.lens (_activatedRule :: WafRuleGroupResource s -> TF.Attr s [TF.Attr s (WafRuleGroupActivatedRuleSetting s)])
...
data WafRuleResource s = WafRuleResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _predicates :: TF.Attr s [TF.Attr s (WafRulePredicatesSetting s)]
    -- ^ @predicates@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasPredicates (WafRuleResource s) (TF.Attr s [TF.Attr s (WafRulePredicatesSetting s)]) where
    predicates =
        P.lens (_predicates :: WafRuleResource s -> TF.Attr s [TF.Attr s (WafRulePredicatesSetting s)])
...
data WafSizeConstraintSetResource s = WafSizeConstraintSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _sizeConstraints :: TF.Attr s [TF.Attr s (WafSizeConstraintSetSizeConstraintsSetting s)]
...
instance P.HasSizeConstraints (WafSizeConstraintSetResource s) (TF.Attr s [TF.Attr s (WafSizeConstraintSetSizeConstraintsSetting s)]) where
    sizeConstraints =
        P.lens (_sizeConstraints :: WafSizeConstraintSetResource s -> TF.Attr s [TF.Attr s (WafSizeConstraintSetSizeConstraintsSetting s)])
...
data WafSqlInjectionMatchSetResource s = WafSqlInjectionMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _sqlInjectionMatchTuples :: TF.Attr s [TF.Attr s (WafSqlInjectionMatchSetSqlInjectionMatchTuplesSetting s)]
...
instance P.HasSqlInjectionMatchTuples (WafSqlInjectionMatchSetResource s) (TF.Attr s [TF.Attr s (WafSqlInjectionMatchSetSqlInjectionMatchTuplesSetting s)]) where
    sqlInjectionMatchTuples =
        P.lens (_sqlInjectionMatchTuples :: WafSqlInjectionMatchSetResource s -> TF.Attr s [TF.Attr s (WafSqlInjectionMatchSetSqlInjectionMatchTuplesSetting s)])
...
data WafWebAclResource s = WafWebAclResource'
    { _defaultAction :: TF.Attr s (WafWebAclDefaultActionSetting s)
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _rules         :: TF.Attr s [TF.Attr s (WafWebAclRulesSetting s)]
    -- ^ @rules@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
wafWebAclResource
    :: TF.Attr s (WafWebAclDefaultActionSetting s) -- ^ @default_action@ ('P._defaultAction', 'P.defaultAction')
    -> TF.Attr s P.Text -- ^ @metric_name@ ('P._metricName', 'P.metricName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance TF.IsValid (WafWebAclResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_defaultAction"
                  (_defaultAction
                      :: WafWebAclResource s -> TF.Attr s (WafWebAclDefaultActionSetting s))
                  TF.validator

instance P.HasDefaultAction (WafWebAclResource s) (TF.Attr s (WafWebAclDefaultActionSetting s)) where
    defaultAction =
        P.lens (_defaultAction :: WafWebAclResource s -> TF.Attr s (WafWebAclDefaultActionSetting s))
...
instance P.HasRules (WafWebAclResource s) (TF.Attr s [TF.Attr s (WafWebAclRulesSetting s)]) where
    rules =
        P.lens (_rules :: WafWebAclResource s -> TF.Attr s [TF.Attr s (WafWebAclRulesSetting s)])
...
data WafXssMatchSetResource s = WafXssMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _xssMatchTuples :: TF.Attr s [TF.Attr s (WafXssMatchSetXssMatchTuplesSetting s)]
...
instance P.HasXssMatchTuples (WafXssMatchSetResource s) (TF.Attr s [TF.Attr s (WafXssMatchSetXssMatchTuplesSetting s)]) where
    xssMatchTuples =
        P.lens (_xssMatchTuples :: WafXssMatchSetResource s -> TF.Attr s [TF.Attr s (WafXssMatchSetXssMatchTuplesSetting s)])
...
data WafregionalByteMatchSetResource s = WafregionalByteMatchSetResource'
    { _byteMatchTuples :: TF.Attr s [TF.Attr s (WafregionalByteMatchSetByteMatchTuplesSetting s)]
    -- ^ @byte_match_tuples@ - (Optional)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Required, Forces New)
...
instance P.HasByteMatchTuples (WafregionalByteMatchSetResource s) (TF.Attr s [TF.Attr s (WafregionalByteMatchSetByteMatchTuplesSetting s)]) where
    byteMatchTuples =
        P.lens (_byteMatchTuples :: WafregionalByteMatchSetResource s -> TF.Attr s [TF.Attr s (WafregionalByteMatchSetByteMatchTuplesSetting s)])
...
data WafregionalGeoMatchSetResource s = WafregionalGeoMatchSetResource'
    { _geoMatchConstraint :: TF.Attr s [TF.Attr s (WafregionalGeoMatchSetGeoMatchConstraintSetting s)]
    -- ^ @geo_match_constraint@ - (Optional)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Required, Forces New)
...
instance P.HasGeoMatchConstraint (WafregionalGeoMatchSetResource s) (TF.Attr s [TF.Attr s (WafregionalGeoMatchSetGeoMatchConstraintSetting s)]) where
    geoMatchConstraint =
        P.lens (_geoMatchConstraint :: WafregionalGeoMatchSetResource s -> TF.Attr s [TF.Attr s (WafregionalGeoMatchSetGeoMatchConstraintSetting s)])
...
data WafregionalIpsetResource s = WafregionalIpsetResource'
    { _ipSetDescriptor :: TF.Attr s [TF.Attr s (WafregionalIpsetIpSetDescriptorSetting s)]
...
instance P.HasIpSetDescriptor (WafregionalIpsetResource s) (TF.Attr s [TF.Attr s (WafregionalIpsetIpSetDescriptorSetting s)]) where
    ipSetDescriptor =
        P.lens (_ipSetDescriptor :: WafregionalIpsetResource s -> TF.Attr s [TF.Attr s (WafregionalIpsetIpSetDescriptorSetting s)])
...
data WafregionalRateBasedRuleResource s = WafregionalRateBasedRuleResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _predicate :: TF.Attr s [TF.Attr s (WafregionalRateBasedRulePredicateSetting s)]
    -- ^ @predicate@ - (Optional)
    --
    , _rateKey :: TF.Attr s P.Text
    -- ^ @rate_key@ - (Required)
...
instance P.HasPredicate (WafregionalRateBasedRuleResource s) (TF.Attr s [TF.Attr s (WafregionalRateBasedRulePredicateSetting s)]) where
    predicate =
        P.lens (_predicate :: WafregionalRateBasedRuleResource s -> TF.Attr s [TF.Attr s (WafregionalRateBasedRulePredicateSetting s)])
...
data WafregionalRegexMatchSetResource s = WafregionalRegexMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _regexMatchTuple :: TF.Attr s [TF.Attr s (WafregionalRegexMatchSetRegexMatchTupleSetting s)]
    -- ^ @regex_match_tuple@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasRegexMatchTuple (WafregionalRegexMatchSetResource s) (TF.Attr s [TF.Attr s (WafregionalRegexMatchSetRegexMatchTupleSetting s)]) where
    regexMatchTuple =
        P.lens (_regexMatchTuple :: WafregionalRegexMatchSetResource s -> TF.Attr s [TF.Attr s (WafregionalRegexMatchSetRegexMatchTupleSetting s)])
...
data WafregionalRuleGroupResource s = WafregionalRuleGroupResource'
    { _activatedRule :: TF.Attr s [TF.Attr s (WafregionalRuleGroupActivatedRuleSetting s)]
    -- ^ @activated_rule@ - (Optional)
    --
    , _metricName :: TF.Attr s P.Text
    -- ^ @metric_name@ - (Required, Forces New)
...
instance P.HasActivatedRule (WafregionalRuleGroupResource s) (TF.Attr s [TF.Attr s (WafregionalRuleGroupActivatedRuleSetting s)]) where
    activatedRule =
        P.lens (_activatedRule :: WafregionalRuleGroupResource s -> TF.Attr s [TF.Attr s (WafregionalRuleGroupActivatedRuleSetting s)])
...
data WafregionalRuleResource s = WafregionalRuleResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _predicate  :: TF.Attr s [TF.Attr s (WafregionalRulePredicateSetting s)]
    -- ^ @predicate@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasPredicate (WafregionalRuleResource s) (TF.Attr s [TF.Attr s (WafregionalRulePredicateSetting s)]) where
    predicate =
        P.lens (_predicate :: WafregionalRuleResource s -> TF.Attr s [TF.Attr s (WafregionalRulePredicateSetting s)])
...
data WafregionalSizeConstraintSetResource s = WafregionalSizeConstraintSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _sizeConstraints :: TF.Attr s [TF.Attr s (WafregionalSizeConstraintSetSizeConstraintsSetting s)]
    -- ^ @size_constraints@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasSizeConstraints (WafregionalSizeConstraintSetResource s) (TF.Attr s [TF.Attr s (WafregionalSizeConstraintSetSizeConstraintsSetting s)]) where
    sizeConstraints =
        P.lens (_sizeConstraints :: WafregionalSizeConstraintSetResource s -> TF.Attr s [TF.Attr s (WafregionalSizeConstraintSetSizeConstraintsSetting s)])
...
data WafregionalSqlInjectionMatchSetResource s = WafregionalSqlInjectionMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _sqlInjectionMatchTuple :: TF.Attr s [TF.Attr s (WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleSetting s)]
...
instance P.HasSqlInjectionMatchTuple (WafregionalSqlInjectionMatchSetResource s) (TF.Attr s [TF.Attr s (WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleSetting s)]) where
    sqlInjectionMatchTuple =
        P.lens (_sqlInjectionMatchTuple :: WafregionalSqlInjectionMatchSetResource s -> TF.Attr s [TF.Attr s (WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleSetting s)])
...
data WafregionalWebAclResource s = WafregionalWebAclResource'
    { _defaultAction :: TF.Attr s (WafregionalWebAclDefaultActionSetting s)
    -- ^ @default_action@ - (Required)
    --
    , _metricName    :: TF.Attr s P.Text
    -- ^ @metric_name@ - (Required, Forces New)
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _rule          :: TF.Attr s [TF.Attr s (WafregionalWebAclRuleSetting s)]
    -- ^ @rule@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
wafregionalWebAclResource
    :: TF.Attr s (WafregionalWebAclDefaultActionSetting s) -- ^ @default_action@ ('P._defaultAction', 'P.defaultAction')
    -> TF.Attr s P.Text -- ^ @metric_name@ ('P._metricName', 'P.metricName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance TF.IsValid (WafregionalWebAclResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_defaultAction"
                  (_defaultAction
                      :: WafregionalWebAclResource s -> TF.Attr s (WafregionalWebAclDefaultActionSetting s))
                  TF.validator

instance P.HasDefaultAction (WafregionalWebAclResource s) (TF.Attr s (WafregionalWebAclDefaultActionSetting s)) where
    defaultAction =
        P.lens (_defaultAction :: WafregionalWebAclResource s -> TF.Attr s (WafregionalWebAclDefaultActionSetting s))
...
instance P.HasRule (WafregionalWebAclResource s) (TF.Attr s [TF.Attr s (WafregionalWebAclRuleSetting s)]) where
    rule =
        P.lens (_rule :: WafregionalWebAclResource s -> TF.Attr s [TF.Attr s (WafregionalWebAclRuleSetting s)])
...
data WafregionalXssMatchSetResource s = WafregionalXssMatchSetResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _xssMatchTuple :: TF.Attr s [TF.Attr s (WafregionalXssMatchSetXssMatchTupleSetting s)]
...
instance P.HasXssMatchTuple (WafregionalXssMatchSetResource s) (TF.Attr s [TF.Attr s (WafregionalXssMatchSetXssMatchTupleSetting s)]) where
    xssMatchTuple =
        P.lens (_xssMatchTuple :: WafregionalXssMatchSetResource s -> TF.Attr s [TF.Attr s (WafregionalXssMatchSetXssMatchTupleSetting s)])
