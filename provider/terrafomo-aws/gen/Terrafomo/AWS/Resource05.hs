...
data MqBrokerResource s = MqBrokerResource'
    ...
    --
    , _configuration :: TF.Attr s (MqBrokerConfigurationSetting s)
    ...
    --
    , _maintenanceWindowStartTime :: TF.Attr s (MqBrokerMaintenanceWindowStartTimeSetting s)
    ...
    --
    , _user :: TF.Attr s [TF.Attr s (MqBrokerUserSetting s)]
    -- ^ @user@ - (Required)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
mqBrokerResource
    ...
    -> TF.Attr s [TF.Attr s (MqBrokerUserSetting s)] -- ^ @user@ ('P._user', 'P.user')
...
instance TF.IsValid (MqBrokerResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_configuration"
                  (_configuration
                      :: MqBrokerResource s -> TF.Attr s (MqBrokerConfigurationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_maintenanceWindowStartTime"
                  (_maintenanceWindowStartTime
                      :: MqBrokerResource s -> TF.Attr s (MqBrokerMaintenanceWindowStartTimeSetting s))
                  TF.validator
...
instance P.HasConfiguration (MqBrokerResource s) (TF.Attr s (MqBrokerConfigurationSetting s)) where
    configuration =
        P.lens (_configuration :: MqBrokerResource s -> TF.Attr s (MqBrokerConfigurationSetting s))
...
instance P.HasMaintenanceWindowStartTime (MqBrokerResource s) (TF.Attr s (MqBrokerMaintenanceWindowStartTimeSetting s)) where
    maintenanceWindowStartTime =
        P.lens (_maintenanceWindowStartTime :: MqBrokerResource s -> TF.Attr s (MqBrokerMaintenanceWindowStartTimeSetting s))
...
instance P.HasUser (MqBrokerResource s) (TF.Attr s [TF.Attr s (MqBrokerUserSetting s)]) where
    user =
        P.lens (_user :: MqBrokerResource s -> TF.Attr s [TF.Attr s (MqBrokerUserSetting s)])
...
instance s ~ s' => P.HasComputedConfiguration (TF.Ref s' (MqBrokerResource s)) (TF.Attr s (MqBrokerConfigurationSetting s)) where
    computedConfiguration x = TF.compute (TF.refKey x) "configuration"

instance s ~ s' => P.HasComputedInstances (TF.Ref s' (MqBrokerResource s)) (TF.Attr s [TF.Attr s (MqBrokerInstancesSetting s)]) where
    computedInstances x = TF.compute (TF.refKey x) "instances"

instance s ~ s' => P.HasComputedMaintenanceWindowStartTime (TF.Ref s' (MqBrokerResource s)) (TF.Attr s (MqBrokerMaintenanceWindowStartTimeSetting s)) where
...
data NeptuneClusterParameterGroupResource s = NeptuneClusterParameterGroupResource'
    ...
    --
    -- * 'name'
    , _parameter :: TF.Attr s [TF.Attr s (NeptuneClusterParameterGroupParameterSetting s)]
    -- ^ @parameter@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance P.HasParameter (NeptuneClusterParameterGroupResource s) (TF.Attr s [TF.Attr s (NeptuneClusterParameterGroupParameterSetting s)]) where
    parameter =
        P.lens (_parameter :: NeptuneClusterParameterGroupResource s -> TF.Attr s [TF.Attr s (NeptuneClusterParameterGroupParameterSetting s)])
...
data NeptuneParameterGroupResource s = NeptuneParameterGroupResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _parameter :: TF.Attr s [TF.Attr s (NeptuneParameterGroupParameterSetting s)]
    -- ^ @parameter@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance P.HasParameter (NeptuneParameterGroupResource s) (TF.Attr s [TF.Attr s (NeptuneParameterGroupParameterSetting s)]) where
    parameter =
        P.lens (_parameter :: NeptuneParameterGroupResource s -> TF.Attr s [TF.Attr s (NeptuneParameterGroupParameterSetting s)])
...
data NetworkAclResource s = NetworkAclResource'
    { _egress    :: TF.Attr s [TF.Attr s (NetworkAclEgressSetting s)]
    -- ^ @egress@ - (Optional)
    --
    , _ingress   :: TF.Attr s [TF.Attr s (NetworkAclIngressSetting s)]
    -- ^ @ingress@ - (Optional)
    --
    , _subnetIds :: TF.Attr s [TF.Attr s P.Text]
    -- ^ @subnet_ids@ - (Optional)
...
instance P.HasEgress (NetworkAclResource s) (TF.Attr s [TF.Attr s (NetworkAclEgressSetting s)]) where
    egress =
        P.lens (_egress :: NetworkAclResource s -> TF.Attr s [TF.Attr s (NetworkAclEgressSetting s)])
               (\s a -> s { _egress = a } :: NetworkAclResource s)

instance P.HasIngress (NetworkAclResource s) (TF.Attr s [TF.Attr s (NetworkAclIngressSetting s)]) where
    ingress =
        P.lens (_ingress :: NetworkAclResource s -> TF.Attr s [TF.Attr s (NetworkAclIngressSetting s)])
...
instance s ~ s' => P.HasComputedEgress (TF.Ref s' (NetworkAclResource s)) (TF.Attr s [TF.Attr s (NetworkAclEgressSetting s)]) where
    computedEgress x = TF.compute (TF.refKey x) "egress"

instance s ~ s' => P.HasComputedIngress (TF.Ref s' (NetworkAclResource s)) (TF.Attr s [TF.Attr s (NetworkAclIngressSetting s)]) where
...
data NetworkInterfaceResource s = NetworkInterfaceResource'
    { _attachment :: TF.Attr s [TF.Attr s (NetworkInterfaceAttachmentSetting s)]
    -- ^ @attachment@ - (Optional)
    --
    , _description :: TF.Attr s P.Text
    -- ^ @description@ - (Optional)
...
instance P.HasAttachment (NetworkInterfaceResource s) (TF.Attr s [TF.Attr s (NetworkInterfaceAttachmentSetting s)]) where
    attachment =
        P.lens (_attachment :: NetworkInterfaceResource s -> TF.Attr s [TF.Attr s (NetworkInterfaceAttachmentSetting s)])
...
instance s ~ s' => P.HasComputedAttachment (TF.Ref s' (NetworkInterfaceResource s)) (TF.Attr s [TF.Attr s (NetworkInterfaceAttachmentSetting s)]) where
...
data OpsworksApplicationResource s = OpsworksApplicationResource'
    { _appSource :: TF.Attr s [TF.Attr s (OpsworksApplicationAppSourceSetting s)]
    -- ^ @app_source@ - (Optional)
    --
    ...
    -- ^ @enable_ssl@ - (Optional)
    --
    , _environment :: TF.Attr s [TF.Attr s (OpsworksApplicationEnvironmentSetting s)]
    ...
    -- ^ @short_name@ - (Optional)
    --
    , _sslConfiguration :: TF.Attr s [TF.Attr s (OpsworksApplicationSslConfigurationSetting s)]
...
instance P.HasAppSource (OpsworksApplicationResource s) (TF.Attr s [TF.Attr s (OpsworksApplicationAppSourceSetting s)]) where
    appSource =
        P.lens (_appSource :: OpsworksApplicationResource s -> TF.Attr s [TF.Attr s (OpsworksApplicationAppSourceSetting s)])
...
instance P.HasEnvironment (OpsworksApplicationResource s) (TF.Attr s [TF.Attr s (OpsworksApplicationEnvironmentSetting s)]) where
    environment =
        P.lens (_environment :: OpsworksApplicationResource s -> TF.Attr s [TF.Attr s (OpsworksApplicationEnvironmentSetting s)])
...
instance P.HasSslConfiguration (OpsworksApplicationResource s) (TF.Attr s [TF.Attr s (OpsworksApplicationSslConfigurationSetting s)]) where
    sslConfiguration =
        P.lens (_sslConfiguration :: OpsworksApplicationResource s -> TF.Attr s [TF.Attr s (OpsworksApplicationSslConfigurationSetting s)])
...
instance s ~ s' => P.HasComputedAppSource (TF.Ref s' (OpsworksApplicationResource s)) (TF.Attr s [TF.Attr s (OpsworksApplicationAppSourceSetting s)]) where
...
data OpsworksCustomLayerResource s = OpsworksCustomLayerResource'
    ...
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksCustomLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
...
instance P.HasEbsVolume (OpsworksCustomLayerResource s) (TF.Attr s [TF.Attr s (OpsworksCustomLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksCustomLayerResource s -> TF.Attr s [TF.Attr s (OpsworksCustomLayerEbsVolumeSetting s)])
...
data OpsworksGangliaLayerResource s = OpsworksGangliaLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksGangliaLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksGangliaLayerResource s) (TF.Attr s [TF.Attr s (OpsworksGangliaLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksGangliaLayerResource s -> TF.Attr s [TF.Attr s (OpsworksGangliaLayerEbsVolumeSetting s)])
...
data OpsworksHaproxyLayerResource s = OpsworksHaproxyLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksHaproxyLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksHaproxyLayerResource s) (TF.Attr s [TF.Attr s (OpsworksHaproxyLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksHaproxyLayerResource s -> TF.Attr s [TF.Attr s (OpsworksHaproxyLayerEbsVolumeSetting s)])
...
data OpsworksInstanceResource s = OpsworksInstanceResource'
    ...
    -- ^ @delete_eip@ - (Optional)
    --
    , _ebsBlockDevice :: TF.Attr s [TF.Attr s (OpsworksInstanceEbsBlockDeviceSetting s)]
    ...
    -- ^ @elastic_ip@ - (Optional)
    --
    , _ephemeralBlockDevice :: TF.Attr s [TF.Attr s (OpsworksInstanceEphemeralBlockDeviceSetting s)]
    ...
    --
    , _rootBlockDevice :: TF.Attr s [TF.Attr s (OpsworksInstanceRootBlockDeviceSetting s)]
...
instance P.HasEbsBlockDevice (OpsworksInstanceResource s) (TF.Attr s [TF.Attr s (OpsworksInstanceEbsBlockDeviceSetting s)]) where
    ebsBlockDevice =
        P.lens (_ebsBlockDevice :: OpsworksInstanceResource s -> TF.Attr s [TF.Attr s (OpsworksInstanceEbsBlockDeviceSetting s)])
...
instance P.HasEphemeralBlockDevice (OpsworksInstanceResource s) (TF.Attr s [TF.Attr s (OpsworksInstanceEphemeralBlockDeviceSetting s)]) where
    ephemeralBlockDevice =
        P.lens (_ephemeralBlockDevice :: OpsworksInstanceResource s -> TF.Attr s [TF.Attr s (OpsworksInstanceEphemeralBlockDeviceSetting s)])
...
instance P.HasRootBlockDevice (OpsworksInstanceResource s) (TF.Attr s [TF.Attr s (OpsworksInstanceRootBlockDeviceSetting s)]) where
    rootBlockDevice =
        P.lens (_rootBlockDevice :: OpsworksInstanceResource s -> TF.Attr s [TF.Attr s (OpsworksInstanceRootBlockDeviceSetting s)])
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (OpsworksInstanceResource s)) (TF.Attr s [TF.Attr s (OpsworksInstanceEbsBlockDeviceSetting s)]) where
...
instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (OpsworksInstanceResource s)) (TF.Attr s [TF.Attr s (OpsworksInstanceEphemeralBlockDeviceSetting s)]) where
...
instance s ~ s' => P.HasComputedRootBlockDevice (TF.Ref s' (OpsworksInstanceResource s)) (TF.Attr s [TF.Attr s (OpsworksInstanceRootBlockDeviceSetting s)]) where
...
data OpsworksJavaAppLayerResource s = OpsworksJavaAppLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksJavaAppLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksJavaAppLayerResource s) (TF.Attr s [TF.Attr s (OpsworksJavaAppLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksJavaAppLayerResource s -> TF.Attr s [TF.Attr s (OpsworksJavaAppLayerEbsVolumeSetting s)])
...
data OpsworksMemcachedLayerResource s = OpsworksMemcachedLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksMemcachedLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksMemcachedLayerResource s) (TF.Attr s [TF.Attr s (OpsworksMemcachedLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksMemcachedLayerResource s -> TF.Attr s [TF.Attr s (OpsworksMemcachedLayerEbsVolumeSetting s)])
...
data OpsworksMysqlLayerResource s = OpsworksMysqlLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksMysqlLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksMysqlLayerResource s) (TF.Attr s [TF.Attr s (OpsworksMysqlLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksMysqlLayerResource s -> TF.Attr s [TF.Attr s (OpsworksMysqlLayerEbsVolumeSetting s)])
...
data OpsworksNodejsAppLayerResource s = OpsworksNodejsAppLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksNodejsAppLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksNodejsAppLayerResource s) (TF.Attr s [TF.Attr s (OpsworksNodejsAppLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksNodejsAppLayerResource s -> TF.Attr s [TF.Attr s (OpsworksNodejsAppLayerEbsVolumeSetting s)])
...
data OpsworksPhpAppLayerResource s = OpsworksPhpAppLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksPhpAppLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksPhpAppLayerResource s) (TF.Attr s [TF.Attr s (OpsworksPhpAppLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksPhpAppLayerResource s -> TF.Attr s [TF.Attr s (OpsworksPhpAppLayerEbsVolumeSetting s)])
...
data OpsworksRailsAppLayerResource s = OpsworksRailsAppLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksRailsAppLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksRailsAppLayerResource s) (TF.Attr s [TF.Attr s (OpsworksRailsAppLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksRailsAppLayerResource s -> TF.Attr s [TF.Attr s (OpsworksRailsAppLayerEbsVolumeSetting s)])
...
data OpsworksStackResource s = OpsworksStackResource'
    ...
    --
    , _customCookbooksSource :: TF.Attr s [TF.Attr s (OpsworksStackCustomCookbooksSourceSetting s)]
...
instance P.HasCustomCookbooksSource (OpsworksStackResource s) (TF.Attr s [TF.Attr s (OpsworksStackCustomCookbooksSourceSetting s)]) where
    customCookbooksSource =
        P.lens (_customCookbooksSource :: OpsworksStackResource s -> TF.Attr s [TF.Attr s (OpsworksStackCustomCookbooksSourceSetting s)])
...
instance s ~ s' => P.HasComputedCustomCookbooksSource (TF.Ref s' (OpsworksStackResource s)) (TF.Attr s [TF.Attr s (OpsworksStackCustomCookbooksSourceSetting s)]) where
...
data OpsworksStaticWebLayerResource s = OpsworksStaticWebLayerResource'
    ...
    -- ^ @drain_elb_on_shutdown@ - (Optional)
    --
    , _ebsVolume :: TF.Attr s [TF.Attr s (OpsworksStaticWebLayerEbsVolumeSetting s)]
    -- ^ @ebs_volume@ - (Optional)
    --
    , _elasticLoadBalancer :: TF.Attr s P.Text
    -- ^ @elastic_load_balancer@ - (Optional)
...
instance P.HasEbsVolume (OpsworksStaticWebLayerResource s) (TF.Attr s [TF.Attr s (OpsworksStaticWebLayerEbsVolumeSetting s)]) where
    ebsVolume =
        P.lens (_ebsVolume :: OpsworksStaticWebLayerResource s -> TF.Attr s [TF.Attr s (OpsworksStaticWebLayerEbsVolumeSetting s)])
...
data RdsClusterParameterGroupResource s = RdsClusterParameterGroupResource'
    ...
    --
    -- * 'name'
    , _parameter :: TF.Attr s [TF.Attr s (RdsClusterParameterGroupParameterSetting s)]
    -- ^ @parameter@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance P.HasParameter (RdsClusterParameterGroupResource s) (TF.Attr s [TF.Attr s (RdsClusterParameterGroupParameterSetting s)]) where
    parameter =
        P.lens (_parameter :: RdsClusterParameterGroupResource s -> TF.Attr s [TF.Attr s (RdsClusterParameterGroupParameterSetting s)])
...
data RdsClusterResource s = RdsClusterResource'
    ...
    -- ^ @replication_source_identifier@ - (Optional)
    --
    , _s3Import :: TF.Attr s (RdsClusterS3ImportSetting s)
    -- ^ @s3_import@ - (Optional)
    --
    -- Conflicts with:
    --
...
instance P.HasS3Import (RdsClusterResource s) (TF.Attr s (RdsClusterS3ImportSetting s)) where
    s3Import =
...
data RedshiftClusterResource s = RedshiftClusterResource'
    ...
    -- ^ @kms_key_id@ - (Optional, Forces New)
    --
    , _logging :: TF.Attr s (RedshiftClusterLoggingSetting s)
    -- ^ @logging@ - (Optional)
    --
    , _masterPassword :: TF.Attr s P.Text
    -- ^ @master_password@ - (Optional)
    ...
    --
    , _snapshotCopy :: TF.Attr s (RedshiftClusterSnapshotCopySetting s)
...
instance TF.IsValid (RedshiftClusterResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_logging"
                  (_logging
                      :: RedshiftClusterResource s -> TF.Attr s (RedshiftClusterLoggingSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_snapshotCopy"
                  (_snapshotCopy
                      :: RedshiftClusterResource s -> TF.Attr s (RedshiftClusterSnapshotCopySetting s))
                  TF.validator
...
instance P.HasLogging (RedshiftClusterResource s) (TF.Attr s (RedshiftClusterLoggingSetting s)) where
    logging =
        P.lens (_logging :: RedshiftClusterResource s -> TF.Attr s (RedshiftClusterLoggingSetting s))
...
instance P.HasSnapshotCopy (RedshiftClusterResource s) (TF.Attr s (RedshiftClusterSnapshotCopySetting s)) where
    snapshotCopy =
        P.lens (_snapshotCopy :: RedshiftClusterResource s -> TF.Attr s (RedshiftClusterSnapshotCopySetting s))
...
data RedshiftParameterGroupResource s = RedshiftParameterGroupResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _parameter :: TF.Attr s [TF.Attr s (RedshiftParameterGroupParameterSetting s)]
    -- ^ @parameter@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasParameter (RedshiftParameterGroupResource s) (TF.Attr s [TF.Attr s (RedshiftParameterGroupParameterSetting s)]) where
    parameter =
        P.lens (_parameter :: RedshiftParameterGroupResource s -> TF.Attr s [TF.Attr s (RedshiftParameterGroupParameterSetting s)])
...
data RedshiftSecurityGroupResource s = RedshiftSecurityGroupResource'
    ...
    -- ^ @description@ - (Optional, Forces New)
    --
    , _ingress :: TF.Attr s [TF.Attr s (RedshiftSecurityGroupIngressSetting s)]
    -- ^ @ingress@ - (Required)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Required, Forces New)
...
redshiftSecurityGroupResource
    :: TF.Attr s [TF.Attr s (RedshiftSecurityGroupIngressSetting s)] -- ^ @ingress@ ('P._ingress', 'P.ingress')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance P.HasIngress (RedshiftSecurityGroupResource s) (TF.Attr s [TF.Attr s (RedshiftSecurityGroupIngressSetting s)]) where
    ingress =
        P.lens (_ingress :: RedshiftSecurityGroupResource s -> TF.Attr s [TF.Attr s (RedshiftSecurityGroupIngressSetting s)])
...
data Route53RecordResource s = Route53RecordResource'
    { _alias :: TF.Attr s [TF.Attr s (Route53RecordAliasSetting s)]
    -- ^ @alias@ - (Optional)
    --
    -- Conflicts with:
    --
    ...
    -- ^ @failover@ - (Optional)
    --
    , _failoverRoutingPolicy :: TF.Attr s [TF.Attr s (Route53RecordFailoverRoutingPolicySetting s)]
    ...
    , _geolocationRoutingPolicy :: TF.Attr s [TF.Attr s (Route53RecordGeolocationRoutingPolicySetting s)]
    ...
    --
    , _latencyRoutingPolicy :: TF.Attr s [TF.Attr s (Route53RecordLatencyRoutingPolicySetting s)]
    ...
    -- ^ @weight@ - (Optional)
    --
    , _weightedRoutingPolicy :: TF.Attr s [TF.Attr s (Route53RecordWeightedRoutingPolicySetting s)]
...
instance P.HasAlias (Route53RecordResource s) (TF.Attr s [TF.Attr s (Route53RecordAliasSetting s)]) where
    alias =
        P.lens (_alias :: Route53RecordResource s -> TF.Attr s [TF.Attr s (Route53RecordAliasSetting s)])
...
instance P.HasFailoverRoutingPolicy (Route53RecordResource s) (TF.Attr s [TF.Attr s (Route53RecordFailoverRoutingPolicySetting s)]) where
    failoverRoutingPolicy =
        P.lens (_failoverRoutingPolicy :: Route53RecordResource s -> TF.Attr s [TF.Attr s (Route53RecordFailoverRoutingPolicySetting s)])
               (\s a -> s { _failoverRoutingPolicy = a } :: Route53RecordResource s)

instance P.HasGeolocationRoutingPolicy (Route53RecordResource s) (TF.Attr s [TF.Attr s (Route53RecordGeolocationRoutingPolicySetting s)]) where
    geolocationRoutingPolicy =
        P.lens (_geolocationRoutingPolicy :: Route53RecordResource s -> TF.Attr s [TF.Attr s (Route53RecordGeolocationRoutingPolicySetting s)])
...
instance P.HasLatencyRoutingPolicy (Route53RecordResource s) (TF.Attr s [TF.Attr s (Route53RecordLatencyRoutingPolicySetting s)]) where
    latencyRoutingPolicy =
        P.lens (_latencyRoutingPolicy :: Route53RecordResource s -> TF.Attr s [TF.Attr s (Route53RecordLatencyRoutingPolicySetting s)])
...
instance P.HasWeightedRoutingPolicy (Route53RecordResource s) (TF.Attr s [TF.Attr s (Route53RecordWeightedRoutingPolicySetting s)]) where
    weightedRoutingPolicy =
        P.lens (_weightedRoutingPolicy :: Route53RecordResource s -> TF.Attr s [TF.Attr s (Route53RecordWeightedRoutingPolicySetting s)])
...
data S3BucketInventoryResource s = S3BucketInventoryResource'
    ...
    --
    , _destination :: TF.Attr s (S3BucketInventoryDestinationSetting s)
    -- ^ @destination@ - (Required)
    --
    , _enabled :: TF.Attr s P.Bool
    -- ^ @enabled@ - (Optional)
    --
    , _filter :: TF.Attr s (S3BucketInventoryFilterSetting s)
    -- ^ @filter@ - (Optional)
    --
    ...
    --
    , _schedule :: TF.Attr s (S3BucketInventoryScheduleSetting s)
    -- ^ @schedule@ - (Required)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
s3BucketInventoryResource
    ...
    -> TF.Attr s (S3BucketInventoryDestinationSetting s) -- ^ @destination@ ('P._destination', 'P.destination')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s (S3BucketInventoryScheduleSetting s) -- ^ @schedule@ ('P._schedule', 'P.schedule')
...
instance TF.IsValid (S3BucketInventoryResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_destination"
                  (_destination
                      :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryDestinationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_filter"
                  (_filter
                      :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryFilterSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_schedule"
                  (_schedule
                      :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryScheduleSetting s))
                  TF.validator
...
instance P.HasDestination (S3BucketInventoryResource s) (TF.Attr s (S3BucketInventoryDestinationSetting s)) where
    destination =
        P.lens (_destination :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryDestinationSetting s))
...
instance P.HasFilter (S3BucketInventoryResource s) (TF.Attr s (S3BucketInventoryFilterSetting s)) where
    filter =
        P.lens (_filter :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryFilterSetting s))
...
instance P.HasSchedule (S3BucketInventoryResource s) (TF.Attr s (S3BucketInventoryScheduleSetting s)) where
    schedule =
        P.lens (_schedule :: S3BucketInventoryResource s -> TF.Attr s (S3BucketInventoryScheduleSetting s))
...
data S3BucketMetricResource s = S3BucketMetricResource'
    ...
    -- ^ @bucket@ - (Required, Forces New)
    --
    , _filter :: TF.Attr s (S3BucketMetricFilterSetting s)
    -- ^ @filter@ - (Optional)
    --
    , _name   :: TF.Attr s P.Text
    -- ^ @name@ - (Required, Forces New)
...
instance TF.IsValid (S3BucketMetricResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_filter"
                  (_filter
                      :: S3BucketMetricResource s -> TF.Attr s (S3BucketMetricFilterSetting s))
                  TF.validator
...
instance P.HasFilter (S3BucketMetricResource s) (TF.Attr s (S3BucketMetricFilterSetting s)) where
    filter =
        P.lens (_filter :: S3BucketMetricResource s -> TF.Attr s (S3BucketMetricFilterSetting s))
...
data S3BucketNotificationResource s = S3BucketNotificationResource'
    ...
    -- ^ @bucket@ - (Required, Forces New)
    --
    , _lambdaFunction :: TF.Attr s [TF.Attr s (S3BucketNotificationLambdaFunctionSetting s)]
    -- ^ @lambda_function@ - (Optional)
    --
    , _queue :: TF.Attr s [TF.Attr s (S3BucketNotificationQueueSetting s)]
    -- ^ @queue@ - (Optional)
    --
    , _topic :: TF.Attr s [TF.Attr s (S3BucketNotificationTopicSetting s)]
    -- ^ @topic@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasLambdaFunction (S3BucketNotificationResource s) (TF.Attr s [TF.Attr s (S3BucketNotificationLambdaFunctionSetting s)]) where
    lambdaFunction =
        P.lens (_lambdaFunction :: S3BucketNotificationResource s -> TF.Attr s [TF.Attr s (S3BucketNotificationLambdaFunctionSetting s)])
               (\s a -> s { _lambdaFunction = a } :: S3BucketNotificationResource s)

instance P.HasQueue (S3BucketNotificationResource s) (TF.Attr s [TF.Attr s (S3BucketNotificationQueueSetting s)]) where
    queue =
        P.lens (_queue :: S3BucketNotificationResource s -> TF.Attr s [TF.Attr s (S3BucketNotificationQueueSetting s)])
               (\s a -> s { _queue = a } :: S3BucketNotificationResource s)

instance P.HasTopic (S3BucketNotificationResource s) (TF.Attr s [TF.Attr s (S3BucketNotificationTopicSetting s)]) where
    topic =
        P.lens (_topic :: S3BucketNotificationResource s -> TF.Attr s [TF.Attr s (S3BucketNotificationTopicSetting s)])
...
data S3BucketResource s = S3BucketResource'
    ...
    --
    -- * 'bucket'
    , _corsRule :: TF.Attr s [TF.Attr s (S3BucketCorsRuleSetting s)]
    -- ^ @cors_rule@ - (Optional)
    --
    , _forceDestroy :: TF.Attr s P.Bool
    -- ^ @force_destroy@ - (Optional)
    ...
    --
    , _lifecycleRule :: TF.Attr s [TF.Attr s (S3BucketLifecycleRuleSetting s)]
    ...
    -- ^ @region@ - (Optional)
    --
    , _replicationConfiguration :: TF.Attr s (S3BucketReplicationConfigurationSetting s)
    -- ^ @replication_configuration@ - (Optional)
    --
    , _requestPayer :: TF.Attr s P.Text
    -- ^ @request_payer@ - (Optional)
    --
    , _serverSideEncryptionConfiguration :: TF.Attr s (S3BucketServerSideEncryptionConfigurationSetting s)
    -- ^ @server_side_encryption_configuration@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
    --
    , _versioning :: TF.Attr s (S3BucketVersioningSetting s)
    -- ^ @versioning@ - (Optional)
    --
    , _website :: TF.Attr s [TF.Attr s (S3BucketWebsiteSetting s)]
    -- ^ @website@ - (Optional)
    --
        ...
        , if (_bucketPrefix P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_replicationConfiguration"
                  (_replicationConfiguration
                      :: S3BucketResource s -> TF.Attr s (S3BucketReplicationConfigurationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_serverSideEncryptionConfiguration"
                  (_serverSideEncryptionConfiguration
                      :: S3BucketResource s -> TF.Attr s (S3BucketServerSideEncryptionConfigurationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_versioning"
                  (_versioning
                      :: S3BucketResource s -> TF.Attr s (S3BucketVersioningSetting s))
                  TF.validator
...
instance P.HasCorsRule (S3BucketResource s) (TF.Attr s [TF.Attr s (S3BucketCorsRuleSetting s)]) where
    corsRule =
        P.lens (_corsRule :: S3BucketResource s -> TF.Attr s [TF.Attr s (S3BucketCorsRuleSetting s)])
...
instance P.HasLifecycleRule (S3BucketResource s) (TF.Attr s [TF.Attr s (S3BucketLifecycleRuleSetting s)]) where
    lifecycleRule =
        P.lens (_lifecycleRule :: S3BucketResource s -> TF.Attr s [TF.Attr s (S3BucketLifecycleRuleSetting s)])
               (\s a -> s { _lifecycleRule = a } :: S3BucketResource s)

instance P.HasLogging (S3BucketResource s) (TF.Attr s [TF.Attr s (S3BucketLoggingSetting s)]) where
    logging =
...
instance P.HasReplicationConfiguration (S3BucketResource s) (TF.Attr s (S3BucketReplicationConfigurationSetting s)) where
    replicationConfiguration =
        P.lens (_replicationConfiguration :: S3BucketResource s -> TF.Attr s (S3BucketReplicationConfigurationSetting s))
...
instance P.HasServerSideEncryptionConfiguration (S3BucketResource s) (TF.Attr s (S3BucketServerSideEncryptionConfigurationSetting s)) where
    serverSideEncryptionConfiguration =
        P.lens (_serverSideEncryptionConfiguration :: S3BucketResource s -> TF.Attr s (S3BucketServerSideEncryptionConfigurationSetting s))
...
instance P.HasVersioning (S3BucketResource s) (TF.Attr s (S3BucketVersioningSetting s)) where
    versioning =
        P.lens (_versioning :: S3BucketResource s -> TF.Attr s (S3BucketVersioningSetting s))
               (\s a -> s { _versioning = a } :: S3BucketResource s)

instance P.HasWebsite (S3BucketResource s) (TF.Attr s [TF.Attr s (S3BucketWebsiteSetting s)]) where
    website =
        P.lens (_website :: S3BucketResource s -> TF.Attr s [TF.Attr s (S3BucketWebsiteSetting s)])
...
instance s ~ s' => P.HasComputedVersioning (TF.Ref s' (S3BucketResource s)) (TF.Attr s (S3BucketVersioningSetting s)) where
...
data SecretsmanagerSecretResource s = SecretsmanagerSecretResource'
    ...
    --
    , _rotationRules :: TF.Attr s (SecretsmanagerSecretRotationRulesSetting s)
...
instance TF.IsValid (SecretsmanagerSecretResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_rotationRules"
                  (_rotationRules
                      :: SecretsmanagerSecretResource s -> TF.Attr s (SecretsmanagerSecretRotationRulesSetting s))
                  TF.validator
...
instance P.HasRotationRules (SecretsmanagerSecretResource s) (TF.Attr s (SecretsmanagerSecretRotationRulesSetting s)) where
    rotationRules =
        P.lens (_rotationRules :: SecretsmanagerSecretResource s -> TF.Attr s (SecretsmanagerSecretRotationRulesSetting s))
...
data SecurityGroupResource s = SecurityGroupResource'
    ...
    -- ^ @description@ - (Optional, Forces New)
    --
    , _egress :: TF.Attr s [TF.Attr s (SecurityGroupEgressSetting s)]
    -- ^ @egress@ - (Optional)
    --
    , _ingress :: TF.Attr s [TF.Attr s (SecurityGroupIngressSetting s)]
    -- ^ @ingress@ - (Optional)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Optional, Forces New)
...
instance P.HasEgress (SecurityGroupResource s) (TF.Attr s [TF.Attr s (SecurityGroupEgressSetting s)]) where
    egress =
        P.lens (_egress :: SecurityGroupResource s -> TF.Attr s [TF.Attr s (SecurityGroupEgressSetting s)])
               (\s a -> s { _egress = a } :: SecurityGroupResource s)

instance P.HasIngress (SecurityGroupResource s) (TF.Attr s [TF.Attr s (SecurityGroupIngressSetting s)]) where
    ingress =
        P.lens (_ingress :: SecurityGroupResource s -> TF.Attr s [TF.Attr s (SecurityGroupIngressSetting s)])
...
instance s ~ s' => P.HasComputedEgress (TF.Ref s' (SecurityGroupResource s)) (TF.Attr s [TF.Attr s (SecurityGroupEgressSetting s)]) where
    computedEgress x = TF.compute (TF.refKey x) "egress"

instance s ~ s' => P.HasComputedIngress (TF.Ref s' (SecurityGroupResource s)) (TF.Attr s [TF.Attr s (SecurityGroupIngressSetting s)]) where
    computedIngress x = TF.compute (TF.refKey x) "ingress"
...
data ServiceDiscoveryServiceResource s = ServiceDiscoveryServiceResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _dnsConfig :: TF.Attr s (ServiceDiscoveryServiceDnsConfigSetting s)
    -- ^ @dns_config@ - (Required)
    --
    , _healthCheckConfig :: TF.Attr s (ServiceDiscoveryServiceHealthCheckConfigSetting s)
    -- ^ @health_check_config@ - (Optional)
    --
    , _healthCheckCustomConfig :: TF.Attr s (ServiceDiscoveryServiceHealthCheckCustomConfigSetting s)
...
serviceDiscoveryServiceResource
    :: TF.Attr s (ServiceDiscoveryServiceDnsConfigSetting s) -- ^ @dns_config@ ('P._dnsConfig', 'P.dnsConfig')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
instance TF.IsValid (ServiceDiscoveryServiceResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_dnsConfig"
                  (_dnsConfig
                      :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceDnsConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_healthCheckConfig"
                  (_healthCheckConfig
                      :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceHealthCheckConfigSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_healthCheckCustomConfig"
                  (_healthCheckCustomConfig
                      :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceHealthCheckCustomConfigSetting s))
                  TF.validator
...
instance P.HasDnsConfig (ServiceDiscoveryServiceResource s) (TF.Attr s (ServiceDiscoveryServiceDnsConfigSetting s)) where
    dnsConfig =
        P.lens (_dnsConfig :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceDnsConfigSetting s))
               (\s a -> s { _dnsConfig = a } :: ServiceDiscoveryServiceResource s)

instance P.HasHealthCheckConfig (ServiceDiscoveryServiceResource s) (TF.Attr s (ServiceDiscoveryServiceHealthCheckConfigSetting s)) where
    healthCheckConfig =
        P.lens (_healthCheckConfig :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceHealthCheckConfigSetting s))
               (\s a -> s { _healthCheckConfig = a } :: ServiceDiscoveryServiceResource s)

instance P.HasHealthCheckCustomConfig (ServiceDiscoveryServiceResource s) (TF.Attr s (ServiceDiscoveryServiceHealthCheckCustomConfigSetting s)) where
    healthCheckCustomConfig =
        P.lens (_healthCheckCustomConfig :: ServiceDiscoveryServiceResource s -> TF.Attr s (ServiceDiscoveryServiceHealthCheckCustomConfigSetting s))
...
data SesEventDestinationResource s = SesEventDestinationResource'
    { _cloudwatchDestination :: TF.Attr s (SesEventDestinationCloudwatchDestinationSetting s)
    ...
    --
    , _kinesisDestination :: TF.Attr s (SesEventDestinationKinesisDestinationSetting s)
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _snsDestination :: TF.Attr s (SesEventDestinationSnsDestinationSetting s)
        ...
        , if (_snsDestination P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_cloudwatchDestination"
                  (_cloudwatchDestination
                      :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationCloudwatchDestinationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_kinesisDestination"
                  (_kinesisDestination
                      :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationKinesisDestinationSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_snsDestination"
                  (_snsDestination
                      :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationSnsDestinationSetting s))
                  TF.validator

instance P.HasCloudwatchDestination (SesEventDestinationResource s) (TF.Attr s (SesEventDestinationCloudwatchDestinationSetting s)) where
    cloudwatchDestination =
        P.lens (_cloudwatchDestination :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationCloudwatchDestinationSetting s))
...
instance P.HasKinesisDestination (SesEventDestinationResource s) (TF.Attr s (SesEventDestinationKinesisDestinationSetting s)) where
    kinesisDestination =
        P.lens (_kinesisDestination :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationKinesisDestinationSetting s))
...
instance P.HasSnsDestination (SesEventDestinationResource s) (TF.Attr s (SesEventDestinationSnsDestinationSetting s)) where
    snsDestination =
        P.lens (_snsDestination :: SesEventDestinationResource s -> TF.Attr s (SesEventDestinationSnsDestinationSetting s))
